...
/*! \file tuple_io.h
 *  \brief Provides streaming capabilities for hydra_thrust::tuple
 */
...
operator<<(std::basic_ostream<CharType, CharTrait>& o, 
  ...
  detail::tuple_detail::print(o, t, hydra_thrust::__make_index_sequence<hydra_thrust::tuple_size<hydra_thrust::tuple<Types...>>::value>{});   // XXX hydra_thrust::__index_sequence_for<Types...>{} upon variadic tuple
...
operator>>(std::basic_istream<CharType, CharTrait>& is, hydra_thrust::tuple<Types...>& t) {
  ...
  detail::tuple_detail::read(is, t, hydra_thrust::__make_index_sequence<hydra_thrust::tuple_size<hydra_thrust::tuple<Types...>>::value>{});   // XXX hydra_thrust::__index_sequence_for<Types...>{} upon variadic tuple
