...
#include <hydra/detail/external/hydra_thrust/system/detail/adl/mismatch.h>
...
{
  using hydra_thrust::system::detail::generic::mismatch;
  return mismatch(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first1, last1, first2);
} // end mismatch()
...
{
  using hydra_thrust::system::detail::generic::mismatch;
  return mismatch(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first1, last1, first2, pred);
} // end mismatch()
                                                      ...
                                                      InputIterator2 first2)
{
  ...
  return hydra_thrust::mismatch(select_system(system1,system2), first1, last1, first2);
} // end mismatch()
                                                      ...
                                                      BinaryPredicate pred)
{
  ...
  return hydra_thrust::mismatch(select_system(system1,system2), first1, last1, first2, pred);
} // end mismatch()
