                    ...
                    OutputIterator result)
{
  ...
  return hydra_thrust::system::omp::detail::dispatch::copy(exec, first, last, result, traversal());
} // end copy()
                      ...
                      OutputIterator result)
{
  ...
  // dispatch on minimum traversal
  return hydra_thrust::system::omp::detail::dispatch::copy_n(exec, first, n, result, traversal());
} // end copy_n()
