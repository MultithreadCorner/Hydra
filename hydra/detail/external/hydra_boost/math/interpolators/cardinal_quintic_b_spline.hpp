...
#ifndef HYDRA_BOOST_MATH_INTERPOLATORS_CARDINAL_QUINTIC_B_SPLINE_HPP
#define HYDRA_BOOST_MATH_INTERPOLATORS_CARDINAL_QUINTIC_B_SPLINE_HPP
#include <memory>
#include <limits>
#include <hydra/detail/external/hydra_boost/math/interpolators/detail/cardinal_quintic_b_spline_detail.hpp>
