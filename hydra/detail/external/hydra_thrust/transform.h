 ...
 * 
 *  hydra_thrust::negate<int> op;
 *
 *  hydra_thrust::transform(hydra_thrust::host, data, data + 10, data, op); // in-place transformation
 *
 ...
 *  hydra_thrust::negate<int> op;
 *
 *  hydra_thrust::transform(data, data + 10, data, op); // in-place transformation
 *
 *  // data is now {5, 0, -2, 3, -2, -4, 0, 1, -2, -8};
 *  \endcode
 *
 ...
 *  ranges using the \p hydra_thrust::host execution policy for parallelization:
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/transform.h>
 *  #include <hydra/detail/external/hydra_thrust/functional.h>
 ...
 *  int output[6];
 * 
 *  hydra_thrust::plus<int> op;
 *
 *  hydra_thrust::transform(hydra_thrust::host, input1, input1 + 6, input2, output, op);
 *
 ...
 *  hydra_thrust::plus<int> op;
 *
 *  hydra_thrust::transform(input1, input1 + 6, input2, output, op);
 *
 *  // output is now {-2,  6,  0,  4,  4,  7};
 *  \endcode
 *
 ...
 *  elements of a range using the \p hydra_thrust::host execution policy for parallelization:
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/transform.h>
 *  #include <hydra/detail/external/hydra_thrust/functional.h>
 ...
 * 
 *  hydra_thrust::negate<int> op;
 *  hydra_thrust::identity<int> identity;
 *
 *  // negate odd elements
 *  hydra_thrust::transform_if(hydra_thrust::host, data, data + 10, data, op, is_odd()); // in-place transformation
 *
 *  // data is now {5, 0, 2, 3, 2, 4, 0, 1, 2, 8};
 *  \endcode
 *
 *  \see hydra_thrust::transform
 */
template<typename DerivedPolicy,
         typename InputIterator,
 ...
 *
 *  // negate odd elements
 *  hydra_thrust::transform_if(data, data + 10, data, op, is_odd()); // in-place transformation
 *
 *  // data is now {5, 0, 2, 3, 2, 4, 0, 1, 2, 8};
 *  \endcode
 *
 ...
 *
 *  The following code snippet demonstrates how to use \p transform_if using the \p hydra_thrust::host
 ...
 *  hydra_thrust::identity<int> identity;
 *
 *  hydra_thrust::transform_if(hydra_thrust::host, data, data + 10, stencil, data, op, identity); // in-place transformation
 *
 *  // data is now {5, 0, -2, -3, -2,  4, 0, -1, -2,  8};
 *  \endcode
 *
 ...
 *  hydra_thrust::identity<int> identity;
 *
 *  hydra_thrust::transform_if(data, data + 10, stencil, data, op, identity); // in-place transformation
 *
 *  // data is now {5, 0, -2, -3, -2,  4, 0, -1, -2,  8};
 *  \endcode
 *
 ...
 *  hydra_thrust::identity<int> identity;
 *
 *  hydra_thrust::transform_if(hydra_thrust::host, input1, input1 + 6, input2, stencil, output, op, identity);
 *
 ...
 *  hydra_thrust::identity<int> identity;
 *
 *  hydra_thrust::transform_if(input1, input1 + 6, input2, stencil, output, op, identity);
 *
 *  // output is now {-2,  0,  0,  3,  4,  4};
 *  \endcode
 *
...
#include <hydra/detail/external/hydra_thrust/detail/transform.inl>
