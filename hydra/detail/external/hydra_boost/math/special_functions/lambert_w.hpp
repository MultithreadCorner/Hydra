...
#include <hydra/detail/external/hydra_boost/math/special_functions/log1p.hpp> // for log (1 + x)
#include <hydra/detail/external/hydra_boost/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <hydra/detail/external/hydra_boost/math/special_functions/pow.hpp> // powers with compile time exponent, used in arbitrary precision code.
...
#include <iostream>
#include <typeinfo>
#include <hydra/detail/external/hydra_boost/math/special_functions/next.hpp>  // For float_distance.
