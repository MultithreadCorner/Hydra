...
int main(int argv, char** argc)
{
	...
	//device
	{
		...
		hydra::Decays<3, hydra::host::sys_t > Events_h1(Events_d );
	...
	//host
	{
		...
		hydra::Decays<3, hydra::host::sys_t > Events_h2( Events_h);
