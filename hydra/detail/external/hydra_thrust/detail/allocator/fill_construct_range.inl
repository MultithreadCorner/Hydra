...
{
  hydra_thrust::for_each_n(allocator_system<Allocator>::get(a), p, n, construct2_via_allocator<Allocator,T>(a, value));
}
...
__host__ __device__
  ...
  >::type
    fill_construct_range(Allocator &a, Pointer p, Size n, const T &value)
{
  hydra_thrust::uninitialized_fill_n(allocator_system<Allocator>::get(a), p, n, value);
}
