 ...
 *  int main(void)
 *  {
 *    hydra_thrust::device_vector<int> vec(1, 13);
 *
 *    hydra_thrust::device_reference<int> ref_to_thirteen = vec[0];
 *
 ...
 *  int main(void)
 *  {
 *    hydra_thrust::device_vector<foo> foo_vec(1);
 *
 *    hydra_thrust::device_reference<foo> foo_ref = foo_vec[0];
 *
             ...
             >
{
  ...
  public:
     ...
     *  #include <assert.h>
     *  ...
     *  hydra_thrust::device_vector<int> v(1,0);
     *  hydra_thrust::device_reference<int> ref = v[0];
     *
     ...
     *  ...
     *  hydra_thrust::device_vector<int> v(1,0);
     *  hydra_thrust::device_ptr<int> ptr = &v[0];
     *  hydra_thrust::device_reference<int> ref(ptr);
     *
...
// they actually exist in a derived-from class
     ...
     *  #include <assert.h>
     *  ...
     *  hydra_thrust::device_vector<int> v(1,1);
     *  hydra_thrust::device_ptr<int> ptr = &v[0];
     *  hydra_thrust::device_reference<int> ref(ptr);
     *
     *  // ref equals 1
     ...
     *  #include <assert.h>
     *  ...
     *  hydra_thrust::device_vector<int> v(1,5);
     *  hydra_thrust::device_ptr<int> ptr = &v[0];
     *  hydra_thrust::device_reference<int> ref(ptr);
     *
     *  // ref equals 5
     ...
     *  #include <assert.h>
     *  ...
     *  hydra_thrust::device_vector<int> v(1,2);
     *  hydra_thrust::device_ptr<int> ptr = &v[0];
     *  hydra_thrust::device_reference<int> ref(ptr);
     *
     *  // ref equals 2
