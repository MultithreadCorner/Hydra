...
public:
	...
	Evaluate(T... a)   const {
		...
		static_assert(
				std::is_convertible<hydra_thrust::tuple<unsigned int,  const hydra::Parameter*, T...>,
				hydra_thrust::tuple<ArgType...>>::value ,
	...
	Evaluate(T a)    const {
		...
		static_assert( std::is_convertible<hydra_thrust::tuple<unsigned int,  const hydra::Parameter*, T>,
				hydra_thrust::tuple<ArgType...>>::value ,
										"\n\n<<< HYDRA_COMPILE_ERROR: Lambda function can not be called with this arguments .>>>\n\n");
		return fLambda(this->GetNumberOfParameters(), this->GetParameters(), a);
	}
	...
	Evaluate(T...a)   const {
		...
		static_assert( std::is_convertible<hydra_thrust::tuple<T...>,
				hydra_thrust::tuple<ArgType...>>::value||
			       std::is_convertible<hydra_thrust::detail::tuple_of_iterator_references<T...>,
			    hydra_thrust::detail::tuple_of_iterator_references<ArgType...>>::value ,
								"\n\n<<< HYDRA_COMPILE_ERROR: Lambda function can not be called with this arguments .>>>\n\n");
		return fLambda( a...);
	}
...
auto wrap_lambda_helper(L const& f, ReturnType, hydra_thrust::tuple<Args...>const& ,
		std::array<Parameter, N> const& parameters)
...
auto wrap_lambda_helper(L const& f, ReturnType&& , hydra_thrust::tuple<Args...>&& )
