 ...
 *  using the standard C library function \c rand using the \p hydra_thrust::host execution policy for parallelization:
 *
 *  \code
 ...
 *  #include <cstdlib>
 *  ...
 *  hydra_thrust::host_vector<int> v(10);
 *  srand(13);
 *  hydra_thrust::generate(hydra_thrust::host, v.begin(), v.end(), rand);
 *
 ...
 *  hydra_thrust::host_vector<int> v(10);
 *  srand(13);
 *  hydra_thrust::generate(v.begin(), v.end(), rand);
 *
 *  // the elements of v are now pseudo-random numbers
 *  \endcode
 *
 ...
 *  hydra_thrust::host_vector<int> v(10);
 *  srand(13);
 *  hydra_thrust::generate_n(hydra_thrust::host, v.begin(), 10, rand);
 *
 *  // the elements of v are now pseudo-random numbers
 *  \endcode
 *
 ...
 *  hydra_thrust::host_vector<int> v(10);
 *  srand(13);
 *  hydra_thrust::generate_n(v.begin(), 10, rand);
 *
 *  // the elements of v are now pseudo-random numbers
 *  \endcode
 *
...
#include <hydra/detail/external/hydra_thrust/detail/generate.inl>
