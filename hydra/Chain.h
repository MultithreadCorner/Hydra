 ...
 */
	...
	/**
	 * Iterator to begin of accept/reject flags range.
	 * @return iterator
	 */
	vector_bool_iterator FlagsBegin() {return fFlags.begin();}

	/**
	 * Iterator to end of accept/reject flags range.
	 * @return iterator
	 */
	vector_bool_iterator FlagsEnd() {return fFlags.end();}

	/**
	 * Iterator to begin of weights range.
	 * @return iterator
	 */
	vector_real_iterator WeightsBegin() {return fWeights.begin();}

	/**
	 * Iterator to end of weights range.
	 * @return iterator
	 */
	...
	/**
	 * Iterator to begin of container range.
	 * @return iterator
	 */
	iterator begin(){ return fBegin; }

	/**
	 * Iterator to end of container range.
	 * @return iterator
	 */
	...
	/**
	 *  Iterator to begin of decay container range.
	 * @return
	 */
	template<unsigned int I>
	...
	/**
	 *  Iterator to end of decay container range.
	 * @return
	 */
	template<unsigned int I>
