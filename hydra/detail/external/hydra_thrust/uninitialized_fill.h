 ...
 *  uninitialized memory using the \p hydra_thrust::device execution policy for parallelization:
 *
 *  \code
 ...
 *  hydra_thrust::uninitialized_fill(hydra_thrust::device, array, array + N, val);
 *
 *  // Int x = array[i];
 ...
 *  Int val(46);
 *  hydra_thrust::device_ptr<Int> array = hydra_thrust::device_malloc<Int>(N);
 *  hydra_thrust::uninitialized_fill(array, array + N, val);
 *
 *  // Int x = array[i];
 *  // x.val == 46 for all 0 <= i < N
 *  \endcode
 ...
 *  Int val(46);
 *  hydra_thrust::device_ptr<Int> array = hydra_thrust::device_malloc<Int>(N);
 *  hydra_thrust::uninitialized_fill_n(hydra_thrust::device, array, N, val);
 *
 *  // Int x = array[i];
 *  // x.val == 46 for all 0 <= i < N
 *  \endcode
 ...
 *  Int val(46);
 *  hydra_thrust::device_ptr<Int> array = hydra_thrust::device_malloc<Int>(N);
 *  hydra_thrust::uninitialized_fill_n(array, N, val);
 *
 *  // Int x = array[i];
 *  // x.val == 46 for all 0 <= i < N
 *  \endcode
