...
template<typename Element>
  struct iterator_traits<hydra_thrust::system::cpp::pointer<Element> >
{
  private:
    typedef hydra_thrust::system::cpp::pointer<Element> ptr;
...
/*! \namespace hydra_thrust::system::cpp
 *  \brief \p hydra_thrust::system::cpp is the namespace containing functionality for allocating, manipulating,
 ...
 *         for import convenience but are also aliased in the top-level <tt>hydra_thrust::cpp</tt>
...
{
  typedef hydra_thrust::system::cpp::reference<Element> type;
...
template<typename T>
  class pointer
    : public hydra_thrust::pointer<
               T,
               hydra_thrust::system::cpp::tag,
               hydra_thrust::system::cpp::reference<T>,
               hydra_thrust::system::cpp::pointer<T>
             >
{
  /*! \cond
   */
  ...
  public:
     ...
     *          to \p hydra_thrust::system::cpp::tag and its element type shall be convertible to \p T.
     */
     ...
     *  \param other The \p OtherPointer to copy.
     *  \tparam OtherPointer The system tag associated with \p OtherPointer shall be convertible
     *          to \p hydra_thrust::system::cpp::tag and its element type shall be \p void.
     */
    template<typename OtherPointer>
    __host__ __device__
    explicit
...
using hydra_thrust::system::cpp::pointer;
using hydra_thrust::system::cpp::reference;

} // end cpp

} // end hydra_thrust

#include <hydra/detail/external/hydra_thrust/system/cpp/detail/pointer.inl>
