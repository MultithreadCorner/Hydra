...
namespace hydra_boost
{
   ...
   HYDRA_BOOST_CXX14_CONSTEXPR typename tools::promote_args<T>::type pow(T base, const Policy& policy);

   template <int N, typename T>
   HYDRA_BOOST_CXX14_CONSTEXPR typename tools::promote_args<T>::type pow(T base);
   ...
   // Lambert W:
   template <class T, class Policy>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_w0(T z, const Policy& pol);
   template <class T>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_w0(T z);
   template <class T, class Policy>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1(T z, const Policy& pol);
   template <class T>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1(T z);
   template <class T, class Policy>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_w0_prime(T z, const Policy& pol);
   template <class T>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_w0_prime(T z);
   template <class T, class Policy>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1_prime(T z, const Policy& pol);
   template <class T>
   typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1_prime(T z);
...
#  define HYDRA_BOOST_MATH_DETAIL_11_FUNC(Policy)\
   template <class T, class U, class V>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type hypergeometric_1F1(const T& a, const U& b, const V& z)\
...
#define HYDRA_BOOST_MATH_DECLARE_SPECIAL_FUNCTIONS(Policy)\
   ...
   \
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type \
   beta(RT1 a, RT2 b) { return ::hydra_boost::math::beta(a, b, Policy()); }\
\
   template <class RT1, class RT2, class A>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2, A>::type \
   beta(RT1 a, RT2 b, A x){ return ::hydra_boost::math::beta(a, b, x, Policy()); }\
\
   template <class RT1, class RT2, class RT3>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2, RT3>::type \
...
\
   template <class T1, class T2, class T3, class T4>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2, T3, T4>::type  \
...
\
   template <class T1, class T2, class T3>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2, T3>::type \
...
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type erf(RT z) { return ::hydra_boost::math::erf(z, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type erfc(RT z){ return ::hydra_boost::math::erfc(z, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type erf_inv(RT z) { return ::hydra_boost::math::erf_inv(z, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type erfc_inv(RT z){ return ::hydra_boost::math::erfc_inv(z, Policy()); }\
\
   using hydra_boost::math::legendre_next;\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type \
...
\
   template <class T1, class T2>\
   inline std::complex<typename hydra_boost::math::tools::promote_args<T1, T2>::type> \
   spherical_harmonic(unsigned n, int m, T1 theta, T2 phi){ return hydra_boost::math::spherical_harmonic(n, m, theta, phi, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type \
...
\
   ...
   \
   template <typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type ellint_2(T k){ return hydra_boost::math::ellint_2(k, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type ellint_2(T1 k, T2 phi){ return hydra_boost::math::ellint_2(k, phi, Policy()); }\
\
   template <typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type ellint_d(T k){ return hydra_boost::math::ellint_d(k, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type ellint_d(T1 k, T2 phi){ return hydra_boost::math::ellint_d(k, phi, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type jacobi_zeta(T1 k, T2 phi){ return hydra_boost::math::jacobi_zeta(k, phi, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type heuman_lambda(T1 k, T2 phi){ return hydra_boost::math::heuman_lambda(k, phi, Policy()); }\
\
   template <typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type ellint_1(T k){ return hydra_boost::math::ellint_1(k, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi){ return hydra_boost::math::ellint_1(k, phi, Policy()); }\
\
   template <class T1, class T2, class T3>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi){ return hydra_boost::math::ellint_3(k, v, phi, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type ellint_3(T1 k, T2 v){ return hydra_boost::math::ellint_3(k, v, Policy()); }\
\
   ...
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type falling_factorial(RT x, unsigned n){ return hydra_boost::math::falling_factorial(x, n, Policy()); }\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type rising_factorial(RT x, unsigned n){ return hydra_boost::math::rising_factorial(x, n, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type tgamma(RT z){ return hydra_boost::math::tgamma(z, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type tgamma1pm1(RT z){ return hydra_boost::math::tgamma1pm1(z, Policy()); }\
\
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type tgamma(RT1 a, RT2 z){ return hydra_boost::math::tgamma(a, z, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type lgamma(RT z, int* sign){ return hydra_boost::math::lgamma(z, sign, Policy()); }\
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type lgamma(RT x){ return hydra_boost::math::lgamma(x, Policy()); }\
\
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type tgamma_lower(RT1 a, RT2 z){ return hydra_boost::math::tgamma_lower(a, z, Policy()); }\
\
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type gamma_q(RT1 a, RT2 z){ return hydra_boost::math::gamma_q(a, z, Policy()); }\
\
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type gamma_p(RT1 a, RT2 z){ return hydra_boost::math::gamma_p(a, z, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type tgamma_delta_ratio(T1 z, T2 delta){ return hydra_boost::math::tgamma_delta_ratio(z, delta, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type tgamma_ratio(T1 a, T2 b) { return hydra_boost::math::tgamma_ratio(a, b, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type gamma_p_derivative(T1 a, T2 x){ return hydra_boost::math::gamma_p_derivative(a, x, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type gamma_p_inv(T1 a, T2 p){ return hydra_boost::math::gamma_p_inv(a, p, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type gamma_p_inva(T1 a, T2 p){ return hydra_boost::math::gamma_p_inva(a, p, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type gamma_q_inv(T1 a, T2 q){ return hydra_boost::math::gamma_q_inv(a, q, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type gamma_q_inva(T1 a, T2 q){ return hydra_boost::math::gamma_q_inva(a, q, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type digamma(T x){ return hydra_boost::math::digamma(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type trigamma(T x){ return hydra_boost::math::trigamma(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type polygamma(int n, T x){ return hydra_boost::math::polygamma(n, x, Policy()); }\
   \
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type \
...
\
   template <class RT>\
   inline typename hydra_boost::math::tools::promote_args<RT>::type cbrt(RT z){ return hydra_boost::math::cbrt(z, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type log1p(T x){ return hydra_boost::math::log1p(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type log1pmx(T x){ return hydra_boost::math::log1pmx(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type expm1(T x){ return hydra_boost::math::expm1(x, Policy()); }\
\
   template <class T1, class T2>\
   inline typename hydra_boost::math::tools::promote_args<T1, T2>::type \
...
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type sqrt1pm1(const T& val){ return hydra_boost::math::sqrt1pm1(val, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type sinc_pi(T x){ return hydra_boost::math::sinc_pi(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type sinhc_pi(T x){ return hydra_boost::math::sinhc_pi(x, Policy()); }\
\
   template<typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type asinh(const T x){ return hydra_boost::math::asinh(x, Policy()); }\
\
   template<typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type acosh(const T x){ return hydra_boost::math::acosh(x, Policy()); }\
\
   template<typename T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type atanh(const T x){ return hydra_boost::math::atanh(x, Policy()); }\
\
   template <class T1, class T2>\
...
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type sin_pi(T x){ return hydra_boost::math::sin_pi(x, Policy()); }\
\
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type cos_pi(T x){ return hydra_boost::math::cos_pi(x, Policy()); }\
\
   ...
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T,U>::type expint(T const& z, U const& u)\
   { return hydra_boost::math::expint(z, u, Policy()); }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type expint(T z){ return hydra_boost::math::expint(z, Policy()); }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type zeta(T s){ return hydra_boost::math::zeta(s, Policy()); }\
   \
   template <class T>\
   ...
   inline typename hydra_boost::math::tools::promote_args<T>::type pow(T v){ return hydra_boost::math::pow<N>(v, Policy()); }\
   \
   template <class T> T nextafter(const T& a, const T& b){ return hydra_boost::math::nextafter(a, b, Policy()); }\
   template <class T> T float_next(const T& a){ return hydra_boost::math::float_next(a, Policy()); }\
   template <class T> T float_prior(const T& a){ return hydra_boost::math::float_prior(a, Policy()); }\
   template <class T> T float_distance(const T& a, const T& b){ return hydra_boost::math::float_distance(a, b, Policy()); }\
   template <class T> T ulp(const T& a){ return hydra_boost::math::ulp(a, Policy()); }\
   \
   template <class RT1, class RT2>\
   inline typename hydra_boost::math::tools::promote_args<RT1, RT2>::type owens_t(RT1 a, RT2 z){ return hydra_boost::math::owens_t(a, z, Policy()); }\
   \
   template <class T1, class T2>\
   ...
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type jacobi_elliptic(T k, T theta, T* pcn, T* pdn)\
   { return hydra_boost::math::jacobi_elliptic(k, theta, pcn, pdn, Policy()); }\
   \
   template <class U, class T>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_sn(U k, T theta)\
   { return hydra_boost::math::jacobi_sn(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_cn(T k, U theta)\
   { return hydra_boost::math::jacobi_cn(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_dn(T k, U theta)\
   { return hydra_boost::math::jacobi_dn(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_cd(T k, U theta)\
   { return hydra_boost::math::jacobi_cd(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_dc(T k, U theta)\
   { return hydra_boost::math::jacobi_dc(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_ns(T k, U theta)\
   { return hydra_boost::math::jacobi_ns(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_sd(T k, U theta)\
   { return hydra_boost::math::jacobi_sd(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_ds(T k, U theta)\
   { return hydra_boost::math::jacobi_ds(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_nc(T k, U theta)\
   { return hydra_boost::math::jacobi_nc(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_nd(T k, U theta)\
   { return hydra_boost::math::jacobi_nd(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_sc(T k, U theta)\
   { return hydra_boost::math::jacobi_sc(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_cs(T k, U theta)\
   { return hydra_boost::math::jacobi_cs(k, theta, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta1(T z, U q)\
   { return hydra_boost::math::jacobi_theta1(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta2(T z, U q)\
   { return hydra_boost::math::jacobi_theta2(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta3(T z, U q)\
   { return hydra_boost::math::jacobi_theta3(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta4(T z, U q)\
   { return hydra_boost::math::jacobi_theta4(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta1tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta1tau(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta2tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta2tau(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta3tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta3tau(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta4tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta4tau(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta3m1(T z, U q)\
   { return hydra_boost::math::jacobi_theta3m1(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta4m1(T z, U q)\
   { return hydra_boost::math::jacobi_theta4m1(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta3m1tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta3m1tau(z, q, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type jacobi_theta4m1tau(T z, U q)\
   { return hydra_boost::math::jacobi_theta4m1tau(z, q, Policy()); }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type airy_ai(T x)\
   {  return hydra_boost::math::airy_ai(x, Policy());  }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type airy_bi(T x)\
   {  return hydra_boost::math::airy_bi(x, Policy());  }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type airy_ai_prime(T x)\
   {  return hydra_boost::math::airy_ai_prime(x, Policy());  }\
   \
   template <class T>\
   inline typename hydra_boost::math::tools::promote_args<T>::type airy_bi_prime(T x)\
   ...
   \
   template <class T> inline typename hydra_boost::math::tools::promote_args<T>::type lambert_w0(T z) { return hydra_boost::math::lambert_w0(z, Policy()); }\
   template <class T> inline typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1(T z) { return hydra_boost::math::lambert_w0(z, Policy()); }\
   template <class T> inline typename hydra_boost::math::tools::promote_args<T>::type lambert_w0_prime(T z) { return hydra_boost::math::lambert_w0(z, Policy()); }\
   template <class T> inline typename hydra_boost::math::tools::promote_args<T>::type lambert_wm1_prime(T z) { return hydra_boost::math::lambert_w0(z, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type hypergeometric_1F0(const T& a, const U& z)\
   { return hydra_boost::math::hypergeometric_1F0(a, z, Policy()); }\
   \
   template <class T, class U>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type hypergeometric_0F1(const T& a, const U& z)\
   { return hydra_boost::math::hypergeometric_0F1(a, z, Policy()); }\
   \
   template <class T, class U, class V>\
   inline typename hydra_boost::math::tools::promote_args<T, U>::type hypergeometric_2F0(const T& a1, const U& a2, const V& z)\
