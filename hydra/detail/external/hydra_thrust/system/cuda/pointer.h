...
/*! \file hydra_thrust/system/cuda/memory.h
...
using pointer = hydra_thrust::pointer<
  ...
  hydra_thrust::tagged_reference<T, hydra_thrust::cuda_cub::tag>
>;
 ...
 */
template <typename T>
using reference = hydra_thrust::tagged_reference<T, hydra_thrust::cuda_cub::tag>;
 ...
 *  \brief \p hydra_thrust::system::cuda is the namespace containing functionality
 ...
 *  underneath \p hydra_thrust::system for import convenience but are also
 *  aliased in the top-level <tt>hydra_thrust::cuda</tt> namespace for easy access.
 *
 */
namespace system { namespace cuda
{
using hydra_thrust::cuda_cub::pointer;
using hydra_thrust::cuda_cub::universal_pointer;
