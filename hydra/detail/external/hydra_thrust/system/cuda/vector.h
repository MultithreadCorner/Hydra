...
/*! \file hydra_thrust/system/cuda/vector.h
 ...
 */
template <typename T, typename Allocator = hydra_thrust::system::cuda::allocator<T>>
 ...
 *  \see universal_vector
 */
template <typename T, typename Allocator = hydra_thrust::system::cuda::universal_allocator<T>>
...
{
using hydra_thrust::cuda_cub::vector;
using hydra_thrust::cuda_cub::universal_vector;
}}
