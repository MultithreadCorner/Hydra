...
/**
 * @file
 * @brief HydraEvaluateExample takes parameters from the command line, fill a range with random numbers and
 * evaluate C++11 lambdas in parallel using the CUDA backend.
...
| Time (ms) = 21.9359
--------------------------------------------------------------
|>   0 [sin(x), cos(x)] = (0.0727845931 0.997347684) ............... [sin(x)^2 + cos(x)^2] = 1
|>   1 [sin(x), cos(x)] = (-0.868691059 -0.49535426) ............... [sin(x)^2 + cos(x)^2] = 1
|>   2 [sin(x), cos(x)] = (-0.915474639 0.402375678) ............... [sin(x)^2 + cos(x)^2] = 1
|>   3 [sin(x), cos(x)] = (-0.908455101 -0.417982451) ............... [sin(x)^2 + cos(x)^2] = 1
|>   4 [sin(x), cos(x)] = (0.818600355 -0.574363525) ............... [sin(x)^2 + cos(x)^2] = 1
|>   5 [sin(x), cos(x)] = (0.80249892 0.596653571) ............... [sin(x)^2 + cos(x)^2] = 1
|>   6 [sin(x), cos(x)] = (0.562754146 0.826624323) ............... [sin(x)^2 + cos(x)^2] = 1
|>   7 [sin(x), cos(x)] = (-0.141790996 0.989896618) ............... [sin(x)^2 + cos(x)^2] = 1
|>   8 [sin(x), cos(x)] = (-0.0156813739 0.99987704) ............... [sin(x)^2 + cos(x)^2] = 1
|>   9 [sin(x), cos(x)] = (-0.136775688 -0.990602045) ............... [sin(x)^2 + cos(x)^2] = 1
 ```
 */
