...
__host__ __device__
  OutputIterator copy_if(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec,
                         ...
                         Predicate pred)
{
  using hydra_thrust::system::detail::generic::copy_if;
  return copy_if(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, result, pred);
} // end copy_if()
...
{
  using hydra_thrust::system::detail::generic::copy_if;
  return copy_if(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, stencil, result, pred);
} // end copy_if()
                         ...
                         Predicate pred)
{
  ...
  return hydra_thrust::copy_if(select_system(system1,system2), first, last, result, pred);
} // end copy_if()
