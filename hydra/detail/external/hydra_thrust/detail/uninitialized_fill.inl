...
__host__ __device__
  void uninitialized_fill(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec,
                          ForwardIterator first,
                          ForwardIterator last,
                          const T &x)
{
  using hydra_thrust::system::detail::generic::uninitialized_fill;
  return uninitialized_fill(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, x);
...
__host__ __device__
  ForwardIterator uninitialized_fill_n(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec,
                                       ForwardIterator first,
                                       Size n,
                                       const T &x)
{
  using hydra_thrust::system::detail::generic::uninitialized_fill_n;
  return uninitialized_fill_n(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, n, x);
                          ...
                          const T &x)
{
  ...
  hydra_thrust::uninitialized_fill(select_system(system), first, last, x);
} // end uninitialized_fill()
                                       ...
                                       const T &x)
{
  ...
  return hydra_thrust::uninitialized_fill_n(select_system(system), first, n, x);
} // end uninitialized_fill_n()
