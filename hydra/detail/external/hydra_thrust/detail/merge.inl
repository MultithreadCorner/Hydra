...
__host__ __device__
  OutputIterator merge(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec,
...
{
  using hydra_thrust::system::detail::generic::merge;
  return merge(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first1, last1, first2, last2, result);
} // end merge()
...
{
  using hydra_thrust::system::detail::generic::merge;
  return merge(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first1, last1, first2, last2, result, comp);
} // end merge()
...
__host__ __device__
  hydra_thrust::pair<OutputIterator1,OutputIterator2>
    merge_by_key(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec,
...
{
  using hydra_thrust::system::detail::generic::merge_by_key;
  return merge_by_key(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), keys_first1, keys_last1, keys_first2, keys_last2, values_first1, values_first2, keys_result, values_result);
} // end merge_by_key()
...
{
  using hydra_thrust::system::detail::generic::merge_by_key;
  return merge_by_key(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), keys_first1, keys_last1, keys_first2, keys_last2, values_first1, values_first2, keys_result, values_result, comp);
} // end merge_by_key()
                       ...
                       StrictWeakOrdering comp)
{
  ...
  return hydra_thrust::merge(select_system(system1,system2,system3), first1, last1, first2, last2, result, comp);
} // end merge()
                       ...
                       OutputIterator result)
{
  ...
  return hydra_thrust::merge(select_system(system1,system2,system3), first1, last1, first2, last2, result);
} // end merge()
                 ...
                 StrictWeakOrdering comp)
{
  ...
  return hydra_thrust::merge_by_key(select_system(system1,system2,system3,system4,system5,system6), keys_first1, keys_last1, keys_first2, keys_last2, values_first1, values_first2, keys_result, values_result, comp);
} // end merge_by_key()
