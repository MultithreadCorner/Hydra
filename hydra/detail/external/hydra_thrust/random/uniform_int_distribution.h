 ...
 *    hydra_thrust::minstd_rand rng;
 *
 *    // create a uniform_int_distribution to produce ints from [-7,13]
 *    hydra_thrust::uniform_int_distribution<int> dist(-7,13);
 *
  ...
  class uniform_int_distribution
{
  public:
    ...
    explicit uniform_int_distribution(IntType a = 0,
                                      IntType b = HYDRA_THRUST_NS_QUALIFIER::detail::integer_traits<IntType>::const_max);
