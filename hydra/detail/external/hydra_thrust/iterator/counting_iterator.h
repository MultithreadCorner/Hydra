...
/*! \file hydra_thrust/iterator/counting_iterator.h
 ...
 *  hydra_thrust::copy(iter, iter + vec.size(), vec.begin());
 *  \endcode
 *
 *  This next example demonstrates how to use a \p counting_iterator with the
 *  \p hydra_thrust::copy_if function to compute the indices of the non-zero elements
