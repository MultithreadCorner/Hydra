...
#ifndef HYDRA_EIGEN_ARCH_GENERIC_PACKET_MATH_FUNCTIONS_FWD_H
#define HYDRA_EIGEN_ARCH_GENERIC_PACKET_MATH_FUNCTIONS_FWD_H
...
#endif // HYDRA_EIGEN_ARCH_GENERIC_PACKET_MATH_FUNCTIONS_FWD_H
