...
template<>
  struct execution_policy<tag>
    : hydra_thrust::system::detail::sequential::execution_policy<tag>
{};
...
template<typename Derived>
  struct execution_policy
    : hydra_thrust::system::detail::sequential::execution_policy<Derived>
{
...
using hydra_thrust::system::cpp::detail::execution_policy;
using hydra_thrust::system::cpp::detail::tag;
...
using hydra_thrust::system::cpp::execution_policy;
