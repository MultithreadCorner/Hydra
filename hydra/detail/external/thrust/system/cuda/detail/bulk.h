...
#define BULK_NAMESPACE_PREFIX  namespace hydra { namespace detail { namespace external {  namespace thrust { namespace system { namespace cuda { namespace detail {
#define BULK_NAMESPACE_SUFFIX                  }                  }                     }                  }                  }                }                  }

// rename "bulk" so it doesn't collide with another installation elsewhere
#define bulk bulk_

#include <hydra/detail/external/thrust/system/cuda/detail/bulk/bulk.hpp>
