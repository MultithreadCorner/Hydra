...
// Trait for checking if a type is a hydra_thrust::optional
...
// Change void to hydra_thrust::monostate
template <class U>
...
/// *Examples*:
/// ```
/// hydra_thrust::optional<int> a = hydra_thrust::nullopt;
/// void foo (hydra_thrust::optional<int>);
/// foo(hydra_thrust::nullopt); //pass an empty optional
/// ```
