...
template<typename Allocator, typename T>
  struct needs_default_construct_via_allocator
    : hydra_thrust::detail::or_<
        ...
        hydra_thrust::detail::not_<has_trivial_constructor<T> > // or if T's default constructor does something interesting
      >
{};
...
template<typename U, typename T>
  struct needs_default_construct_via_allocator<std::allocator<U>, T>
    : hydra_thrust::detail::not_<has_trivial_constructor<T> >
{};
...
{
  hydra_thrust::for_each_n(allocator_system<Allocator>::get(a), p, n, construct1_via_allocator<Allocator>(a));
}
...
__host__ __device__
  ...
  >::type
    default_construct_range(Allocator &a, Pointer p, Size n)
{
  hydra_thrust::uninitialized_fill_n(allocator_system<Allocator>::get(a), p, n, typename pointer_element<Pointer>::type());
}
