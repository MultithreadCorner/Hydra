 ...
 *  #include <hydra/detail/external/hydra_thrust/system.h>
 ...
 *    try
 *    {
 *      hydra_thrust::device_vector<float> vec;
 *      hydra_thrust::sort(vec.begin(), vec.end());
 *    }
 *    catch(hydra_thrust::system_error e)
 *    {
