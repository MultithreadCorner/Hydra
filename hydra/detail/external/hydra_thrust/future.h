...
/*! \file hydra_thrust/future.h
 *  \brief `hydra_thrust::future`, an asynchronous value type.
 */
...
using host_unique_eager_event = unique_eager_event_type_detail::select<
  hydra_thrust::system::__HYDRA_THRUST_HOST_SYSTEM_NAMESPACE::tag
>;
...
using host_unique_eager_future = unique_eager_future_type_detail::select<
  hydra_thrust::system::__HYDRA_THRUST_HOST_SYSTEM_NAMESPACE::tag, T
>;
template <typename T>
...
using device_unique_eager_event = unique_eager_event_type_detail::select<
  hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::tag
>;
...
using device_unique_eager_future = unique_eager_future_type_detail::select<
  hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::tag, T
>;
...
using hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::when_all;
