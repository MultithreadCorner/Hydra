 ...
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/transform_scan.h>
 *  #include <hydra/detail/external/hydra_thrust/execution_policy.h>
 *  ...
 *  
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *
 *  hydra_thrust::negate<int> unary_op;
 *  hydra_thrust::plus<int> binary_op;
 *
 *  hydra_thrust::transform_inclusive_scan(hydra_thrust::host, data, data + 6, data, unary_op, binary_op); // in-place scan
 *
 ...
 *  hydra_thrust::plus<int> binary_op;
 *
 *  hydra_thrust::transform_inclusive_scan(data, data + 6, data, unary_op, binary_op); // in-place scan
 *
 *  // data is now {-1, -1, -3, -5, -6, -9}
 *  \endcode
 *
 ...
 *  hydra_thrust::plus<int> binary_op;
 *
 *  hydra_thrust::transform_exclusive_scan(hydra_thrust::host, data, data + 6, data, unary_op, 4, binary_op); // in-place scan
 *
 ...
 *  hydra_thrust::plus<int> binary_op;
 *
 *  hydra_thrust::transform_exclusive_scan(data, data + 6, data, unary_op, 4, binary_op); // in-place scan
 *
 *  // data is now {4, 3, 3, 1, -1, -2}
 *  \endcode
 *
...
#include <hydra/detail/external/hydra_thrust/detail/transform_scan.inl>
