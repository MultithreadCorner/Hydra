...
template<> struct random_traits<hydra_r123::Philox2x64>
{
	...
	typedef typename hydra_r123::Philox2x64::ukey_type  seed_type;
...
template<> struct random_traits<hydra_r123::Threefry2x64>
{
	...
	typedef typename hydra_r123::Threefry2x64::ukey_type  seed_type;
	typedef uint64_t advance_type;
	typedef uint64_t    init_type;
	typedef uint64_t  result_type;
...
template<> struct random_traits<hydra_r123::ARS4x32>
{
	...
	typedef typename hydra_r123::ARS4x32::ukey_type  seed_type;
	typedef uint64_t advance_type;
	typedef uint32_t    init_type;
	typedef uint64_t  result_type;
