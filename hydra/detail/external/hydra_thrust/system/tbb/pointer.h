...
template<typename Element>
  struct iterator_traits<hydra_thrust::system::tbb::pointer<Element> >
{
  private:
    typedef hydra_thrust::system::tbb::pointer<Element> ptr;
...
/*! \namespace hydra_thrust::system::tbb
 *  \brief \p hydra_thrust::system::tbb is the namespace containing functionality for allocating, manipulating,
 ...
 *         for import convenience but are also aliased in the top-level <tt>hydra_thrust::tbb</tt>
...
{
  typedef hydra_thrust::system::tbb::reference<Element> type;
...
template<typename T>
  class pointer
    : public hydra_thrust::pointer<
               ...
               hydra_thrust::system::tbb::reference<T>,
               hydra_thrust::system::tbb::pointer<T>
             >
{
  /*! \cond
   */
  ...
  public:
     ...
     *          to \p hydra_thrust::system::tbb::tag and its element type shall be convertible to \p T.
     */
     ...
     *  \param other The \p OtherPointer to copy.
     *  \tparam OtherPointer The system tag associated with \p OtherPointer shall be convertible
     *          to \p hydra_thrust::system::tbb::tag and its element type shall be \p void.
     */
    template<typename OtherPointer>
    __host__ __device__
    explicit
...
#include <hydra/detail/external/hydra_thrust/system/tbb/detail/pointer.inl>
