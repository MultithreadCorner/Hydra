...
/*! \file hydra_thrust/iterator/retag.h
 ...
 *  \tparam Tag \p Tag shall be convertible to <tt>hydra_thrust::iterator_system<Iterator>::type</tt>,
 *              or <tt>hydra_thrust::iterator_system<Iterator>::type</tt> is a base type of \p Tag.
 *  \tparam Iterator Any iterator type.
 *  \param iter The iterator of interest.
