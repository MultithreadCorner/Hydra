...
#include <hydra/detail/external/hydra_thrust/universal_allocator.h>

// #include the device system's vector header
#define __HYDRA_THRUST_DEVICE_SYSTEM_VECTOR_HEADER <__HYDRA_THRUST_DEVICE_SYSTEM_ROOT/vector.h>
#include __HYDRA_THRUST_DEVICE_SYSTEM_VECTOR_HEADER
#undef __HYDRA_THRUST_DEVICE_SYSTEM_VECTOR_HEADER
 ...
 *  \see device_vector
 */
using hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::universal_vector;
