...
template<typename DerivedPolicy,
         ...
         typename T>
__host__ __device__
  ForwardIterator remove(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                         ...
                         const T &value)
{
  ...
  return hydra_thrust::remove_if(exec, first, last, pred);
} // end remove()
...
template<typename DerivedPolicy,
         ...
         typename T>
__host__ __device__
  OutputIterator remove_copy(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                             InputIterator first,
                             InputIterator last,
                             ...
                             const T &value)
{
  ...
  // XXX consider using a placeholder here
  return hydra_thrust::remove_copy_if(exec, first, last, result, pred);
} // end remove_copy()
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  ForwardIterator remove_if(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                            ForwardIterator first,
                            ForwardIterator last,
                            Predicate pred)
{
  ...
  // remove into temp
  return hydra_thrust::remove_copy_if(exec, temp.begin(), temp.end(), temp.begin(), first, pred);
} // end remove_if()
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  OutputIterator remove_copy_if(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                                InputIterator first,
                                InputIterator last,
                                OutputIterator result,
                                Predicate pred)
{
  return hydra_thrust::remove_copy_if(exec, first, last, first, result, pred);
} // end remove_copy_if()
...
__host__ __device__
  OutputIterator remove_copy_if(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                                ...
                                Predicate pred)
{
  return hydra_thrust::copy_if(exec, first, last, stencil, result, hydra_thrust::detail::not1(pred));
} // end remove_copy_if()
