...
// Rebind `hydra_thrust::pointer`-like things with `hydra_thrust::reference`-like references.
...
// Rebind `hydra_thrust::pointer`-like things with native reference types.
template<template<typename, typename, typename, typename...> class Ptr, typename OldT, typename Tag,
         typename... PtrTail, typename T>
...
// Rebind `hydra_thrust::pointer`-like things with native reference types and templated
// derived types.
template<template<typename, typename, typename, typename...> class Ptr, typename OldT, typename Tag,
         template<typename...> class DerivedPtr, typename... DerivedPtrTail,
         typename T>
