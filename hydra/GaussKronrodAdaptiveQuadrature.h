...
If the interval [''a'', ''b''] is subdivided, the Gauss evaluation points of the new subintervals never coincide with the previous
 ...
 Gauss–Kronrod formulas are extensions of the Gauss quadrature formulas generated by adding <math>n+1</math> points to an <math>n</math>-point
  rule in such a way that the resulting rule is of order <math>2n+1</math> ({{harvtxt|Laurie|1997|loc=p. 1133}};
