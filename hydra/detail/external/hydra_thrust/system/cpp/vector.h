...
/*! \file hydra_thrust/system/cpp/vector.h
 ...
 */
template <typename T, typename Allocator = hydra_thrust::system::cpp::allocator<T>>
 ...
 *  \see universal_vector
 */
template <typename T, typename Allocator = hydra_thrust::system::cpp::universal_allocator<T>>
...
namespace cpp
{
using hydra_thrust::system::cpp::vector;
using hydra_thrust::system::cpp::universal_vector;
}
