...
__host__ __device__
  ...
  >::type
    uninitialized_copy_with_allocator(Allocator &a,
                                      const hydra_thrust::execution_policy<FromSystem> &,
                                      const hydra_thrust::execution_policy<ToSystem> &to_system,
                                      InputIterator first,
                                      InputIterator last,
                                      Pointer result)
{
  // zip up the iterators
  typedef hydra_thrust::tuple<InputIterator,Pointer> IteratorTuple;
  ...
  hydra_thrust::for_each(to_system, begin, end, copy_construct_with_allocator<Allocator,InputType,OutputType>(a));
                                        ...
                                        Pointer result)
{
  ...
  ZipIterator end = hydra_thrust::for_each_n(to_system, begin, n, copy_construct_with_allocator<Allocator,InputType,OutputType>(a));
...
__host__ __device__
  ...
  >::type
    uninitialized_copy_with_allocator(Allocator &,
                                      const hydra_thrust::execution_policy<FromSystem> &from_system,
                                      const hydra_thrust::execution_policy<ToSystem> &to_system,
                                      InputIterator first,
                                      InputIterator last,
                                      Pointer result)
{
  ...
  return hydra_thrust::detail::two_system_copy(from_system, to_system, first, last, result);
                                        ...
                                        Pointer result)
{
  ...
  return hydra_thrust::detail::two_system_copy_n(from_system, to_system, first, n, result);
...
__host__ __device__
  typename disable_if<
    ...
    Pointer
  >::type
    copy_construct_range(hydra_thrust::execution_policy<FromSystem> &from_system,
                         Allocator &a,
                         InputIterator first,
                         InputIterator last,
                         Pointer result)
{
  ...
  return hydra_thrust::detail::two_system_copy(from_system, allocator_system<Allocator>::get(a), first, last, result);
}
...
__host__ __device__
  typename disable_if<
    ...
    Pointer
  >::type
    copy_construct_range_n(hydra_thrust::execution_policy<FromSystem> &from_system,
                           Allocator &a,
                           InputIterator first,
                           Size n,
                           Pointer result)
{
  ...
  return hydra_thrust::detail::two_system_copy_n(from_system, allocator_system<Allocator>::get(a), first, n, result);
}
