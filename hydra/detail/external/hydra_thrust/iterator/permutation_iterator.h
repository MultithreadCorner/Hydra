...
/*! \file hydra_thrust/iterator/permutation_iterator.h
 ...
 *  ...
 *  hydra_thrust::device_vector<float> values(4);
 *  values[0] = 10.0f;
 *  values[1] = 20.0f;
 *  values[2] = 30.0f;
 *  values[3] = 40.0f;
 ...
 *  values[7] = 80.0f;
 *
 *  hydra_thrust::device_vector<int> indices(4);
 *  indices[0] = 2;
 *  indices[1] = 6;
 *  indices[2] = 1;
 *  indices[3] = 3;
 *
 *  typedef hydra_thrust::device_vector<float>::iterator ElementIterator;
 *  typedef hydra_thrust::device_vector<int>::iterator   IndexIterator;
 *
 *  hydra_thrust::permutation_iterator<ElementIterator,IndexIterator> iter(values.begin(), indices.begin());
 *
 *  *iter;   // returns 30.0f;
