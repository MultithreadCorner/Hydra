 ...
 *  };
 *  ...
 *  hydra_thrust::device_vector<int> d_vec(3);
 *  d_vec[0] = 0; d_vec[1] = 1; d_vec[2] = 2;
 *
 *  hydra_thrust::for_each(hydra_thrust::device, d_vec.begin(), d_vec.end(), printf_functor());
 *
 ...
 *  of a \p device_vector using the \p hydra_thrust::device parallelization policy.
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/for_each.h>
 *  #include <hydra/detail/external/hydra_thrust/device_vector.h>
 ...
 *  d_vec[0] = 0; d_vec[1] = 1; d_vec[2] = 2;
 *
 *  hydra_thrust::for_each_n(hydra_thrust::device, d_vec.begin(), d_vec.size(), printf_functor());
 *
 *  // 0 1 2 is printed to standard output in some unspecified order
 *  \endcode
 *
 ...
 *  d_vec[0] = 0; d_vec[1] = 1; d_vec[2] = 2;
 *
 *  hydra_thrust::for_each(d_vec.begin(), d_vec.end(), printf_functor());
 *
 *  // 0 1 2 is printed to standard output in some unspecified order
 *  \endcode
 *
 ...
 *  d_vec[0] = 0; d_vec[1] = 1; d_vec[2] = 2;
 *
 *  hydra_thrust::for_each_n(d_vec.begin(), d_vec.size(), printf_functor());
 *
 *  // 0 1 2 is printed to standard output in some unspecified order
 *  \endcode
 *
