 ...
 */
template<typename Element, typename Pointer, typename Derived = hydra_thrust::use_default>
  class reference
{
  public:
 ...
 *
 *  \pre \p DerivedPolicy must be publically derived from <code>hydra_thrust::execution_policy<DerivedPolicy></code>.
 *
...
template<typename DerivedPolicy, typename Pointer>
__host__ __device__
void return_temporary_buffer(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &system, Pointer p);
