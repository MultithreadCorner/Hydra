...
__host__ __device__
  OutputIterator replace_copy_if(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                                 InputIterator first,
                                 InputIterator last,
                                 ...
                                 const T &new_value)
{
  ...
  return hydra_thrust::transform(exec, first, last, result, op);
} // end replace_copy_if()
                                 ...
                                 const T &new_value)
{
  ...
  detail::new_value_if<Predicate,T,OutputType> op(pred,new_value);
  return hydra_thrust::transform(exec, first, last, stencil, result, op);
} // end replace_copy_if()


template<typename DerivedPolicy, typename InputIterator, typename OutputIterator, typename T>
__host__ __device__
  OutputIterator replace_copy(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                              InputIterator first,
                              InputIterator last,
                              OutputIterator result,
                              const T &old_value,
...
__host__ __device__
  void replace_if(hydra_thrust::execution_policy<DerivedPolicy> &exec,
                  ...
                  const T &new_value)
{
  ...
  hydra_thrust::transform_if(exec, first, last, first, first, f, pred);
} // end replace_if()
...
{
  detail::constant_unary<T> f(new_value);
  hydra_thrust::transform_if(exec, first, last, stencil, first, f, pred);
} // end replace_if()


template<typename DerivedPolicy, typename ForwardIterator, typename T>
__host__ __device__
  void replace(hydra_thrust::execution_policy<DerivedPolicy> &exec,
               ForwardIterator first,
               ForwardIterator last,
               const T &old_value,
               const T &new_value)
