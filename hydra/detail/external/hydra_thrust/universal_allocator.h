...
#define __HYDRA_THRUST_DEVICE_SYSTEM_MEMORY_HEADER <__HYDRA_THRUST_DEVICE_SYSTEM_ROOT/memory.h>
 ...
 */
using hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::universal_allocator;
 ...
 *  policies (\p hydra_thrust::device, etc) can be used to specify where an algorithm
 *  should be run.
 *
...
template <typename T>
using universal_ptr =
  hydra_thrust::system::__HYDRA_THRUST_DEVICE_SYSTEM_NAMESPACE::universal_pointer<T>;
