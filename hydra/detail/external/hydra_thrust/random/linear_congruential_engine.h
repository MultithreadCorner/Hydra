 ...
 *    hydra_thrust::minstd_rand rng2(13);
 *
 ...
 *    std::cout << hydra_thrust::minstd_rand::min << std::endl;
 *    std::cout << hydra_thrust::minstd_rand::max << std::endl;
 *
 *    // the range of minstd_rand is printed
 *
 *    // save the state of rng2 to a different object
 *    hydra_thrust::minstd_rand rng3 = rng2;
 *
 ...
 *  \endcode
 *
 *  \see hydra_thrust::random::minstd_rand
 *  \see hydra_thrust::random::minstd_rand0
 */
