 ...
 */
template<hydra::Wave L >
class Resonance: public hydra::BaseFunctor<Resonance<L>,hydra::complex<double>(Kaon, PionA, PionB) , 4>
{
	typedef hydra::BaseFunctor<Resonance<L>, hydra::complex<double>(Kaon, PionA, PionB), 4> super_type;
