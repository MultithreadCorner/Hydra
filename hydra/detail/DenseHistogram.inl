...
void DenseHistogram<N, T, detail::multidimensional>::Fill(Iterator1 begin, Iterator1 end, Iterator2 wbegin )
{
	...
	auto reduced_end = HYDRA_EXTERNAL_NS::thrust::reduce_by_key(system_t(), key_buffer.first,
...
void DenseHistogram<N, T, detail::multidimensional>::Fill(detail::BackendPolicy<BACKEND> const& exec_policy,
...
void DenseHistogram<N, T, detail::multidimensional>::Fill(detail::BackendPolicy<BACKEND> const& exec_policy, Iterator begin, Iterator end )
{
...
template<typename T>
template<hydra::detail::Backend BACKEND, typename Iterator>
void DenseHistogram<1, T, detail::unidimensional>::Fill(detail::BackendPolicy<BACKEND> const& exec_policy,
...
void DenseHistogram<1, T,detail::unidimensional >::Fill(Iterator1 begin, Iterator1 end, Iterator2 wbegin )
{
	...
	HYDRA_EXTERNAL_NS::thrust::fill( system_t(), bin_contents.first, bin_contents.first+bin_contents.second, 0.0);
