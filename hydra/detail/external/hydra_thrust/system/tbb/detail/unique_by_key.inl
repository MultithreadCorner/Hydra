                  ...
                  BinaryPredicate binary_pred)
{
  ...
  return hydra_thrust::system::detail::generic::unique_by_key(exec,keys_first,keys_last,values_first,binary_pred);
} // end unique_by_key()
                       ...
                       BinaryPredicate binary_pred)
{
  ...
  return hydra_thrust::system::detail::generic::unique_by_key_copy(exec,keys_first,keys_last,values_first,keys_output,values_output,binary_pred);
