 ...
 *  of a range using the \p hydra_thrust::host execution policy for parallelization:
 *
 *  \code
 ...
 *  int result = hydra_thrust::transform_reduce(hydra_thrust::host,
 *                                        data, data + 6,
 *                                        absolute_value<int>(),
 *                                        0,
 ...
 *
 *  int data[6] = {-1, 0, -2, -2, 1, -3};
 *  int result = hydra_thrust::transform_reduce(data, data + 6,
 *                                        absolute_value<int>(),
 *                                        0,
 *                                        hydra_thrust::maximum<int>());
 *  // result == 3
...
#include <hydra/detail/external/hydra_thrust/detail/transform_reduce.inl>
