...
/*! \namespace hydra_thrust::random
 *  \brief \p hydra_thrust::random is the namespace which contains random number engine class templates,
 ...
 *  for import convenience but are also aliased in the top-level \p hydra_thrust namespace for
 *  easy access.
 */
namespace random
{
