                   ...
                   HYDRA_EXTERNAL_NS::Eigen::aligned_allocator_indirection<HYDRA_EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T)> >
{
  typedef deque<HYDRA_EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T),
                HYDRA_EXTERNAL_NS::Eigen::aligned_allocator_indirection<HYDRA_EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T)> > deque_base;
...
#elif defined(_GLIBCXX_DEQUE) && HYDRA_EIGEN_GNUC_AT_LEAST(4,2)
