...
int main(int argv, char** argc)
{
   ...
   auto fft_r2c = hydra::RealToComplexCuFFT<FloatType>( nentries );
   ...
   auto fft_c2c_f = hydra::ComplexToComplexCuFFT<FloatType>( nentries , +1);
   ...
   auto fft_c2c_b = hydra::ComplexToComplexCuFFT<FloatType>( nentries , -1);
