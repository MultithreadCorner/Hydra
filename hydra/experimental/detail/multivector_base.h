...
#ifndef MULTIVECTOR_BASE_H_
#define MULTIVECTOR_BASE_H_

#include <hydra/detail/Config.h>
#include <hydra/Types.h>
#include <hydra/experimental/detail/multivector_base.inc>
...
public:
	 ...
	 * default constructor
	 */
	explicit multivector_base();

	/**
	 * constructor size_t n
	 */
	explicit multivector_base(size_t n);

	/**
	 * constructor size_t n, ...values
	 */

	explicit multivector_base(size_t n, T... value);
...
#include <hydra/experimental/detail/multivector_base.inl>

#endif /* MULTIVECTOR_BASE_H_ */
