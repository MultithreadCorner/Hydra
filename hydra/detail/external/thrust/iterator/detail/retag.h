...
__hydra_host__ __hydra_device__
  HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<Iterator,Tag>
    reinterpret_tag(Iterator iter)
{
  return HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<Iterator,Tag>(iter);
} // end reinterpret_tag()
...
__hydra_host__ __hydra_device__
  HYDRA_EXTERNAL_NS::thrust::pointer<T,Tag>
    reinterpret_tag(T *ptr)
{
  return HYDRA_EXTERNAL_NS::thrust::pointer<T,Tag>(ptr);
} // end reinterpret_tag()


// specialization for HYDRA_EXTERNAL_NS::thrust::pointer
template<typename Tag, typename T, typename OtherTag, typename Reference, typename Derived>
__hydra_host__ __hydra_device__
  HYDRA_EXTERNAL_NS::thrust::pointer<T,Tag>
    reinterpret_tag(HYDRA_EXTERNAL_NS::thrust::pointer<T,OtherTag,Reference,Derived> ptr)
{
...
__hydra_host__ __hydra_device__
  HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<BaseIterator,Tag>
    reinterpret_tag(HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<BaseIterator,OtherTag> iter)
{
...
template<typename Tag, typename Iterator>
__hydra_host__ __hydra_device__
  typename HYDRA_EXTERNAL_NS::thrust::detail::enable_if_retaggable<
    typename HYDRA_EXTERNAL_NS::thrust::iterator_system<Iterator>::type,
    Tag,
    HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<Iterator,Tag>
  >::type
    retag(Iterator iter)
...
__hydra_host__ __hydra_device__
  typename HYDRA_EXTERNAL_NS::thrust::detail::enable_if_retaggable<
    typename HYDRA_EXTERNAL_NS::thrust::iterator_system<T*>::type,
    Tag,
    HYDRA_EXTERNAL_NS::thrust::pointer<T,Tag>
  >::type
    retag(T *ptr)
...
__hydra_host__ __hydra_device__
  typename HYDRA_EXTERNAL_NS::thrust::detail::enable_if_retaggable<
    ...
    HYDRA_EXTERNAL_NS::thrust::pointer<T,Tag>
  >::type
    retag(HYDRA_EXTERNAL_NS::thrust::pointer<T,OtherTag> ptr)
{
  return reinterpret_tag<Tag>(ptr);
} // end retag()
...
__hydra_host__ __hydra_device__
  typename HYDRA_EXTERNAL_NS::thrust::detail::enable_if_retaggable<
    ...
    HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<BaseIterator,Tag>
  >::type
    retag(HYDRA_EXTERNAL_NS::thrust::detail::tagged_iterator<BaseIterator,OtherTag> iter)
{
  return reinterpret_tag<Tag>(iter);
} // end retag()
