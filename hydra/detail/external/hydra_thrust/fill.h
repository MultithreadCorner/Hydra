 ...
 *  elements to a given value using the \p hydra_thrust::device execution policy for parallelization:
 *
 *  \code
 ...
 *  ...
 *  hydra_thrust::device_vector<int> v(4);
 *  hydra_thrust::fill(hydra_thrust::device, v.begin(), v.end(), 137);
 *
 ...
 *  ...
 *  hydra_thrust::device_vector<int> v(4);
 *  hydra_thrust::fill(v.begin(), v.end(), 137);
 *
 *  // v[0] == 137, v[1] == 137, v[2] == 137, v[3] == 137
 *  \endcode
 *
 ...
 *  ...
 *  hydra_thrust::device_vector<int> v(4);
 *  hydra_thrust::fill_n(hydra_thrust::device, v.begin(), v.size(), 137);
 *
 *  // v[0] == 137, v[1] == 137, v[2] == 137, v[3] == 137
 *  \endcode
 *
 ...
 *  ...
 *  hydra_thrust::device_vector<int> v(4);
 *  hydra_thrust::fill_n(v.begin(), v.size(), 137);
 *
 *  // v[0] == 137, v[1] == 137, v[2] == 137, v[3] == 137
 *  \endcode
 *
