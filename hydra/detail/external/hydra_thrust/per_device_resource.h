...
#include <hydra/detail/external/hydra_thrust/system/detail/generic/per_device_resource.h>
#include <hydra/detail/external/hydra_thrust/system/detail/adl/per_device_resource.h>
...
__host__
MR * get_per_device_resource(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> & system)
{
    using hydra_thrust::system::detail::generic::get_per_device_resource;

    return get_per_device_resource<MR>(
        hydra_thrust::detail::derived_cast(
            hydra_thrust::detail::strip_const(system)));
}
 ...
 *      \p hydra_thrust::mr::memory_resource and must be \p final.
...
class per_device_allocator : public hydra_thrust::mr::allocator<T, Upstream>
{
