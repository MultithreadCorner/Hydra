...
/*! \file hydra_thrust/iterator/iterator_facade.h
...
/*! \p iterator_core_access is the class which user iterator types derived from \p hydra_thrust::iterator_adaptor
 *  or \p hydra_thrust::iterator_facade must befriend to allow it to access their private interface.
 */
