...
// we make this exception for equal and use __hydra_thrust_exec_check_disable__ because it is used in vector's implementation
...
{
  return hydra_thrust::mismatch(exec, first1, last1, first2, binary_pred).first == last1;
}
