...
{
  using hydra_thrust::system::detail::generic::tabulate;
  return tabulate(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, unary_op);
} // end tabulate()
                ...
                UnaryOperation unary_op)
{
  ...
  return hydra_thrust::tabulate(select_system(system), first, last, unary_op);
} // end tabulate()
