...
struct par_t : hydra_thrust::system::omp::detail::execution_policy<par_t>,
  hydra_thrust::detail::allocator_aware_execution_policy<
    hydra_thrust::system::omp::detail::execution_policy>
{
  __host__ __device__
  constexpr par_t() : hydra_thrust::system::omp::detail::execution_policy<par_t>() {}
};
...
using hydra_thrust::system::omp::par;
