...
#ifndef HYDRA_BOOST_MATH_SPECIAL_HERMITE_HPP
#define HYDRA_BOOST_MATH_SPECIAL_HERMITE_HPP
   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "hydra_boost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return hydra_boost::math::hermite(n, x, policies::policy<>());
}

} // namespace math
} // namespace hydra_boost

#endif // HYDRA_BOOST_MATH_SPECIAL_HERMITE_HPP
