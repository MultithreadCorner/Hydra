...
template<typename Element>
  struct iterator_traits<HYDRA_EXTERNAL_NS::thrust::system::cpp::pointer<Element> >
{
  private:
    typedef HYDRA_EXTERNAL_NS::thrust::system::cpp::pointer<Element> ptr;
...
/*! \HYDRA_EXTERNAL_NAMESPACE_BEGIN  namespace HYDRA_EXTERNAL_NS::thrust::system::cpp
 *  \brief \p HYDRA_EXTERNAL_NS::thrust::system::cpp is the namespace containing functionality for allocating, manipulating,
 ...
 *         for import convenience but are also aliased in the top-level <tt>HYDRA_EXTERNAL_NS::thrust::cpp</tt>
...
{
  typedef HYDRA_EXTERNAL_NS::thrust::system::cpp::reference<Element> type;
...
template<typename T>
  class pointer
    : public HYDRA_EXTERNAL_NS::thrust::pointer<
               T,
               HYDRA_EXTERNAL_NS::thrust::system::cpp::tag,
               HYDRA_EXTERNAL_NS::thrust::system::cpp::reference<T>,
               HYDRA_EXTERNAL_NS::thrust::system::cpp::pointer<T>
             >
{
  /*! \cond
   */
  ...
  public:
    // note that cpp::pointer's member functions need __hydra_host__ __hydra_device__
     ...
     *          to \p HYDRA_EXTERNAL_NS::thrust::system::cpp::tag and its element type shall be convertible to \p T.
     */
     ...
     *  \param other The \p OtherPointer to copy.
     *  \tparam OtherPointer The system tag associated with \p OtherPointer shall be convertible
     *          to \p HYDRA_EXTERNAL_NS::thrust::system::cpp::tag and its element type shall be \p void.
     */
    template<typename OtherPointer>
    __hydra_host__ __hydra_device__
    explicit
...
using HYDRA_EXTERNAL_NS::thrust::system::cpp::pointer;
using HYDRA_EXTERNAL_NS::thrust::system::cpp::reference;
...
#include <hydra/detail/external/thrust/system/cpp/detail/pointer.inl>
