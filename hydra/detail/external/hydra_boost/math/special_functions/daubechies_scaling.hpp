...
#ifndef HYDRA_BOOST_MATH_SPECIAL_DAUBECHIES_SCALING_HPP
#define HYDRA_BOOST_MATH_SPECIAL_DAUBECHIES_SCALING_HPP
...
#include <iostream>
#include <memory>
#include <hydra/detail/external/hydra_boost/math/special_functions/detail/daubechies_scaling_integer_grid.hpp>
#include <hydra/detail/external/hydra_boost/math/filters/daubechies.hpp>
#include <hydra/detail/external/hydra_boost/math/interpolators/detail/cubic_hermite_detail.hpp>
#include <hydra/detail/external/hydra_boost/math/interpolators/detail/quintic_hermite_detail.hpp>
...
#    error "The header <hydra/detail/external/hydra_boost/special_functions/daubechies_scaling.hpp> can only be used in C++17 and later."
#  endif
#endif
...
std::vector<Real> daubechies_scaling_dyadic_grid(int64_t j_max)
{
    using std::isnan;
    using std::sqrt;
    auto c = hydra_boost::math::filters::daubechies_scaling_filter<Real, p>();
