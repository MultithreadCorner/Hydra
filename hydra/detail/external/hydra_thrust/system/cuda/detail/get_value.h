...
inline __host__ __device__
  typename hydra_thrust::iterator_value<Pointer>::type
    get_value_msvc2005_war(execution_policy<DerivedPolicy> &exec, Pointer ptr)
{
  typedef typename hydra_thrust::iterator_value<Pointer>::type result_type;
  ...
  struct war_nvbugs_881631
  {
    __host__ inline static result_type host_path(execution_policy<DerivedPolicy> &exec, Pointer ptr)
    {
      ...
      hydra_thrust::host_system_tag host_tag;
      cross_system<hydra_thrust::host_system_tag, DerivedPolicy> systems(host_tag, exec);
    ...
    __device__ inline static result_type device_path(execution_policy<DerivedPolicy> &, Pointer ptr)
    {
      ...
      return *hydra_thrust::raw_pointer_cast(ptr);
    }
  };
