 ...
 *  ...
 *  hydra_thrust::device_vector<int> vec(13);
 *  hydra_thrust::device_vector<int>::iterator iter = vec.begin();
 *
 *  hydra_thrust::advance(iter, 7);
 *
 *  // iter - vec.begin() == 7
 *  \endcode
 *
 ...
 *  ...
 *  hydra_thrust::device_vector<int> vec(13);
 *  hydra_thrust::device_vector<int>::iterator i0 = vec.begin();
 *
 *  auto i1 = hydra_thrust::next(i0);
 *
 *  // i0 - vec.begin() == 0
 *  // i1 - vec.begin() == 1
 *  \endcode
 ...
 *  ...
 *  hydra_thrust::device_vector<int> vec(13);
 *  hydra_thrust::device_vector<int>::iterator i0 = vec.end();
 *
 *  auto i1 = hydra_thrust::prev(i0);
 *
 *  // vec.end() - i0 == 0
 *  // vec.end() - i1 == 1
 *  \endcode
