 ...
 *  hydra_thrust::device_vector<int> vec(5,0);
 *  vec[1] = 1;
 *  vec[3] = 1;
 *  vec[4] = 1;
 *  
 *  // count the 1s
 *  int result = hydra_thrust::count(hydra_thrust::device, vec.begin(), vec.end(), 1);
 *  // result == 3
 *  \endcode
 *
 ...
 *  
 *  // count the 1s
 *  int result = hydra_thrust::count(vec.begin(), vec.end(), 1);
 *  // result == 3
 *  \endcode
 *
 *  \see http://www.sgi.com/tech/stl/count.html
 ...
 *  hydra_thrust::device_vector<int> vec(5);
 *  vec[0] = 0;
 *  vec[1] = 1;
 *  vec[2] = 2;
 *  vec[3] = 3;
 ...
 *  int result = hydra_thrust::count_if(hydra_thrust::device, vec.begin(), vec.end(), is_odd());
 *  // result == 2
 *  \endcode
 *
 *  \see http://www.sgi.com/tech/stl/count.html
 ...
 *
 *  // count the odd elements in vec
 *  int result = hydra_thrust::count_if(vec.begin(), vec.end(), is_odd());
 *  // result == 2
 *  \endcode
 *
 *  \see http://www.sgi.com/tech/stl/count.html
