...
{
  typedef typename hydra_thrust::iterator_system<pointer>::type System;
        ...
        ::strip_const_get_value(const System &system) const
{
  ...
  return get_value(hydra_thrust::detail::derived_cast(non_const_system), m_ptr);
...
{
  typedef typename hydra_thrust::iterator_system<pointer>::type      System1;
  typedef typename hydra_thrust::iterator_system<OtherPointer>::type System2;
      ...
      ::strip_const_assign_value(const System &system, OtherPointer src)
{
  ...
  assign_value(hydra_thrust::detail::derived_cast(non_const_system), m_ptr, src);
