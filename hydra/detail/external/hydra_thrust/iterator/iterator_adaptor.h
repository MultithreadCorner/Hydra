...
/*! \file hydra_thrust/iterator/iterator_adaptor.h
 ...
 *      : public hydra_thrust::iterator_adaptor<
 ...
 *
 *      // befriend hydra_thrust::iterator_core_access to allow it access to the private interface below
 ...
 *
 *      // it is private because only hydra_thrust::iterator_core_access needs access to it
 *      __host__ __device__
 ...
 *  user specifies \p hydra_thrust::use_default in its place, \p iterator_adaptor will use a default type inferred from \p Base.
 *
