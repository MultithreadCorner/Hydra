...
// inifinite recursion in hydra_thrust entry points:
//
// template<typename DerivedPolicy>
// void foo(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &s)
// {
//   using hydra_thrust::system::detail::generic::foo;
//
//   foo(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(s));
// }
//
// foo is not recursive when
// 1. DerivedPolicy is derived from hydra_thrust::execution_policy below
// 2. generic::foo takes hydra_thrust::execution_policy as a parameter
template<typename DerivedPolicy>
