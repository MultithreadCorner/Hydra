...
#ifndef HYDRA_BOOST_MATH_BESSEL_ITERATORS_HPP
#define HYDRA_BOOST_MATH_BESSEL_ITERATORS_HPP
   ...
   namespace math {
      namespace detail {
         ...
         struct bessel_jy_recurrence
         {
            ...
            hydra_boost::math::tuple<T, T, T> operator()(int k)
            {
               return hydra_boost::math::tuple<T, T, T>(1, -2 * (v + k) / z, 1);
            }
      ...
      template <class T, class Policy = hydra_boost::math::policies::policy<> >
      struct bessel_j_backwards_iterator
      {
         ...
         bessel_j_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_jy_recurrence<T>(v, x), hydra_boost::math::cyl_bessel_j(v, x, Policy())) 
         {
            if(v < 0)
               hydra_boost::math::policies::raise_domain_error("bessel_j_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         hydra_boost::math::tools::backward_recurrence_iterator< detail::bessel_jy_recurrence<T> > it;
      };
      ...
      struct bessel_i_backwards_iterator
      {
         ...
         bessel_i_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_ik_recurrence<T>(v, x), hydra_boost::math::cyl_bessel_i(v, x, Policy()))
         {
            if(v < -1)
               hydra_boost::math::policies::raise_domain_error("bessel_i_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         hydra_boost::math::tools::backward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
      ...
      struct bessel_i_forwards_iterator
      {
         ...
         {
            if(v > 1)
               hydra_boost::math::policies::raise_domain_error("bessel_i_forwards_iterator<%1%>", "Order must be < 0 stable forwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         hydra_boost::math::tools::forward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
