...
{
  hydra_thrust::for_each_n(allocator_system<Allocator>::get(a), p, n, destroy_via_allocator<Allocator>(a));
}
...
__host__ __device__
  typename enable_if_destroy_range_case2<Allocator,Pointer>::type
    destroy_range(Allocator &a, Pointer p, Size n)
{
  hydra_thrust::for_each_n(allocator_system<Allocator>::get(a), p, n, gozer());
}
