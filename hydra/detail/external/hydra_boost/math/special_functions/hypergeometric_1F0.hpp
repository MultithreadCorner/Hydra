...
#ifndef HYDRA_BOOST_MATH_HYPERGEOMETRIC_1F0_HPP
#define HYDRA_BOOST_MATH_HYPERGEOMETRIC_1F0_HPP
...
{
   static const char* function = "hydra_boost::math::hypergeometric_1F0<%1%,%1%>(%1%, %1%)";
   HYDRA_BOOST_MATH_STD_USING // pow
...
inline typename tools::promote_args<T1, T2>::type hypergeometric_1F0(T1 a, T2 z, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::hypergeometric_1F0_imp<value_type>(
         ...
         forwarding_policy()),
      "hydra_boost::math::hypergeometric_1F0<%1%>(%1%,%1%)");
}
...
#endif // HYDRA_BOOST_MATH_HYPERGEOMETRIC_1F0_HPP
