...
{
  hydra_thrust::random::linear_congruential_engine<result_type,
...
{
  return hydra_thrust::random::detail::random_core_access::stream_out(os,e);
}
...
{
  return hydra_thrust::random::detail::random_core_access::stream_in(is,e);
}
