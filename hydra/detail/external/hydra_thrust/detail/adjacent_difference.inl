                                   ...
                                   OutputIterator result)
{
  ...
  return adjacent_difference(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, result);
                                   ...
                                   BinaryFunction binary_op)
{
  ...
  return adjacent_difference(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)), first, last, result, binary_op);
} // end adjacent_difference()
                                   ...
                                   OutputIterator result)
{
  ...
  return hydra_thrust::adjacent_difference(select_system(system1, system2), first, last, result);
} // end adjacent_difference()
                                   ...
                                   BinaryFunction binary_op)
{
  ...
  return hydra_thrust::adjacent_difference(select_system(system1, system2), first, last, result, binary_op);
} // end adjacent_difference()
