 ...
 *  compute the dot product of two vectors using the \p hydra_thrust::host execution policy for parallelization.
 *
 *  \code
 ...
 *
 *  float result = hydra_thrust::inner_product(hydra_thrust::host, vec1, vec1 + 3, vec2, 0.0f);
 *
 *  // result == 31.0f
 *  \endcode
 *
 ...
 *  float vec2[3] = {4.0f, 1.0f, 5.0f};
 *
 *  float result = hydra_thrust::inner_product(vec1, vec1 + 3, vec2, 0.0f);
 *
 *  // result == 31.0f
 *  \endcode
 *
 ...
 *
 *  float init = 0.0f;
 *  hydra_thrust::plus<float>       binary_op1;
 *  hydra_thrust::multiplies<float> binary_op2;
 *
 *  float result = hydra_thrust::inner_product(hydra_thrust::host, vec1, vec1 + 3, vec2, init, binary_op1, binary_op2);
 *
 *  // result == 31.0f
 *  \endcode
 *
 ...
 *  hydra_thrust::multiplies<float> binary_op2;
 *
 *  float result = hydra_thrust::inner_product(vec1, vec1 + 3, vec2, init, binary_op1, binary_op2);
 *
 *  // result == 31.0f
 *  \endcode
 *
