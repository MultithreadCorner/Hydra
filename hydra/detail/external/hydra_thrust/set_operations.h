 ...
 *  int result[3];
 *
 *  int *result_end = hydra_thrust::set_difference(hydra_thrust::host, A1, A1 + 7, A2, A2 + 5, result);
 *  // result is now {0, 4, 6}
 *  \endcode
 *
 ...
 *  int result[3];
 *
 *  int *result_end = hydra_thrust::set_difference(A1, A1 + 7, A2, A2 + 5, result);
 *  // result is now {0, 4, 6}
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/set_difference
 ...
 *  int result[3];
 *
 *  int *result_end = hydra_thrust::set_difference(hydra_thrust::host, A1, A1 + 7, A2, A2 + 5, result, hydra_thrust::greater<int>());
 *  // result is now {6, 4, 0}
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/set_difference
 ...
 *  int result[3];
 *
 *  int *result_end = hydra_thrust::set_difference(A1, A1 + 7, A2, A2 + 5, result, hydra_thrust::greater<int>());
 *  // result is now {6, 4, 0}
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/set_difference
 ...
 *  int result[6];
 *
 *  int *result_end = hydra_thrust::set_symmetric_difference(hydra_thrust::host, A1, A1 + 7, A2, A2 + 5, result);
 *  // result = {0, 4, 5, 6, 7, 8}
 *  \endcode
 *
 ...
 *  int result[6];
 *
 *  int *result_end = hydra_thrust::set_symmetric_difference(A1, A1 + 7, A2, A2 + 5, result);
 *  // result = {0, 4, 5, 6, 7, 8}
 *  \endcode
 *
 *  \see https://en.cppreference.com/w/cpp/algorithm/set_symmetric_difference
