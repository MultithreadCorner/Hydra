...
#ifndef HYDRA_BOOST_MATH_HANKEL_HPP
#define HYDRA_BOOST_MATH_HANKEL_HPP
...
std::complex<T> hankel_imp(T v, T x, const bessel_no_int_tag&, const Policy& pol, int sign)
{
   ...
   static const char* function = "hydra_boost::math::cyl_hankel_1<%1%>(%1%,%1%)";
...
inline std::complex<typename detail::bessel_traits<T1, T2, Policy>::result_type> cyl_hankel_1(T1 v, T2 x, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<std::complex<result_type>, Policy>(detail::hankel_imp<value_type>(v, static_cast<value_type>(x), tag_type(), pol, 1), "hydra_boost::math::cyl_hankel_1<%1%>(%1%,%1%)");
}
...
inline std::complex<typename detail::bessel_traits<T1, T2, Policy>::result_type> sph_hankel_1(T1 v, T2 x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<std::complex<result_type>, Policy>(detail::sph_hankel_imp<value_type>(static_cast<value_type>(v), static_cast<value_type>(x), forwarding_policy(), 1), "hydra_boost::math::sph_hankel_1<%1%>(%1%,%1%)");
}
...
#endif // HYDRA_BOOST_MATH_HANKEL_HPP
