...
#include <hydra/detail/external/hydra_boost/math/distributions/complement.hpp> // complement.
#include <hydra/detail/external/hydra_boost/math/distributions/detail/common_error_handling.hpp> // error checks domain_error & logic_error.
...
namespace hydra_boost
{
  namespace math
  {
    ...
    { // Cumulative Distribution Function of geometric.
      using std::pow;
      static const char* function = "hydra_boost::math::logcdf(const geometric_distribution<%1%>&, %1%)";
    ...
    { // Complemented Cumulative Distribution Function geometric.
      ...
      return hydra_boost::math::log1p(-p, Policy()) * (k+1);
