...
#ifndef INTEGRATORTRAITS_H_
#define INTEGRATORTRAITS_H_
...
template<class T>
struct is_hydra_integrator<T,
        hydra::thrust::void_t<typename T::hydra_integrator_type> >: std::true_type {};
