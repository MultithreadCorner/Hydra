                            ...
                            StrictWeakOrdering comp)
{
    ...
    return hydra_thrust::system::detail::generic::lower_bound(exec, begin, end, value, comp);
}
                            ...
                            StrictWeakOrdering comp)
{
    ...
    return hydra_thrust::system::detail::generic::upper_bound(exec, begin, end, value, comp);
}
                   ...
                   StrictWeakOrdering comp)
{
    ...
    return hydra_thrust::system::detail::generic::binary_search(exec, begin, end, value, comp);
}
