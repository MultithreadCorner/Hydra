function(ADD_HYDRA_EXAMPLE target_name)
        ...
        if(BUILD_TBB_TARGETS)
                 ...
                 add_executable("${target_name}_tbb" EXCLUDE_FROM_ALL  "${target_name}.cpp" )
        ...
        if(BUILD_CPP_TARGETS)
                 ...
                 add_executable("${target_name}_cpp" EXCLUDE_FROM_ALL  "${target_name}.cpp" )
        ...
        if(BUILD_OMP_TARGETS)
                 ...
                 add_executable("${target_name}_omp" EXCLUDE_FROM_ALL  "${target_name}.cpp" )
