        ...
        ::operator()(UniformRandomNumberGenerator &urng, const param_type &parm)
{
  ...
  typedef typename hydra_thrust::detail::largest_available_float::type float_type;
...
{
  return hydra_thrust::random::detail::random_core_access::equal(lhs,rhs);
}
...
{
  return hydra_thrust::random::detail::random_core_access::stream_out(os,d);
}
...
{
  return hydra_thrust::random::detail::random_core_access::stream_in(is,d);
}
