 ...
 *
 * @image html HIST_2D_gaussians_CCP_OMP_DEVICE.png
 * @image html HIST_2D_lambda_CCP_OMP_DEVICE.png
 * @image html HIST_2D_gaussians_CCP_OMP_HOST.png
 * @image html HIST_2D_lambda_CCP_OMP_HOST.png
 * @image html HIST_1D_uniform_CCP_OMP_DEVICE.png
 * @image html HIST_1D_gaussian_CCP_OMP_DEVICE.png
 * @image html HIST_1D_breit_wigner_CCP_OMP_DEVICE.png
 * @image html HIST_1D_exponential_CCP_OMP_DEVICE.png
 * @image html HIST_1D_uniform_CCP_OMP_HOST.png
 * @image html HIST_1D_gaussian_CCP_OMP_HOST.png
 * @image html HIST_1D_breit_wigner_CCP_OMP_HOST.png
 * @image html HIST_1D_exponential_CCP_OMP_HOST.png
 */
...
GInt_t main(int argv, char** argc)
{
	...
	//------------------------
	TH1D hist_uniform_DEVICE("uniform_CCP_OMP_DEVICE", "Uniform distribution (DEVICE)", 100, -5.5, 5.5);
	TH1D hist_gaussian_DEVICE("gaussian_CCP_OMP_DEVICE", "Gaussian distribution (DEVICE)", 100, -5, 5);
    TH1D hist_exp_DEVICE("exponential_CCP_OMP_DEVICE", "Exponential distribution (DEVICE)", 100, 0, 5);
    TH1D hist_bw_DEVICE("breit_wigner_CCP_OMP_DEVICE", "Breit-Wigner distribution (DEVICE)", 100, 0, 5);
