 ...
 *  a value of interest in a \c device_vector with another using the \p hydra_thrust::device
 ...
 *  ...
 *  
 *  hydra_thrust::device_vector<int> A(4);
 *  A[0] = 1;
 *  A[1] = 2;
 *  A[2] = 3;
 *  A[3] = 1;
 *
 *  hydra_thrust::replace(hydra_thrust::device, A.begin(), A.end(), 1, 99);
 *
 ...
 *  A[3] = 1;
 *
 *  hydra_thrust::replace(A.begin(), A.end(), 1, 99);
 *
 *  // A contains [99, 2, 3, 99]
 *  \endcode
 *
 ...
 *  a \c device_vector's negative elements with \c 0 using the \p hydra_thrust::device execution policy
 *  for parallelization:
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/replace.h>
 ...
 *
 *  hydra_thrust::replace_if(hydra_thrust::device, A.begin(), A.end(), pred, 0);
 *
 *  // A contains [1, 0, 2, 0]
 *  \endcode
 *
 ...
 *  is_less_than_zero pred;
 *
 *  hydra_thrust::replace_if(A.begin(), A.end(), pred, 0);
 *
 *  // A contains [1, 0, 2, 0]
 *  \endcode
 *
 ...
 *  using the \p hydra_thrust::device execution policy for parallelization:
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/replace.h>
 *  #include <hydra/detail/external/hydra_thrust/device_vector.h>
 ...
 *  A[3] =  40;
 *
 *  hydra_thrust::device_vector<int> S(4);
 *  S[0] = -1;
 *  S[1] =  0;
 *  S[2] = -1;
 *  S[3] =  0;
 *
 *  is_less_than_zero pred;
 *  hydra_thrust::replace_if(hydra_thrust::device, A.begin(), A.end(), S.begin(), pred, 0);
 *
 ...
 *
 *  is_less_than_zero pred;
 *  hydra_thrust::replace_if(A.begin(), A.end(), S.begin(), pred, 0);
 *
 *  // A contains [0, 20, 0, 40]
 *  \endcode
 *
 ...
 *  A[3] = 1;
 *
 *  hydra_thrust::device_vector<int> B(4);
 *
 *  hydra_thrust::replace_copy(hydra_thrust::device, A.begin(), A.end(), B.begin(), 1, 99);
 *
 ...
 *  hydra_thrust::device_vector<int> B(4);
 *
 *  hydra_thrust::replace_copy(A.begin(), A.end(), B.begin(), 1, 99);
 *
 *  // B contains [99, 2, 3, 99]
 *  \endcode
 *
 ...
 *  is_less_than_zero pred;
 *
 *  hydra_thrust::replace_copy_if(hydra_thrust::device, A.begin(), A.end(), B.begin(), pred, 0);
 *
 *  // B contains [1, 0, 2, 0]
 *  \endcode
 *
 ...
 *  is_less_than_zero pred;
 *
 *  hydra_thrust::replace_copy_if(A.begin(), A.end(), B.begin(), pred, 0);
 *
 *  // B contains [1, 0, 2, 0]
 *  \endcode
 *
 ...
 *  is_less_than_zero pred;
 *
 *  hydra_thrust::replace_if(hydra_thrust::device, A.begin(), A.end(), S.begin(), B.begin(), pred, 0);
 *
 ...
 *  is_less_than_zero pred;
 *
 *  hydra_thrust::replace_if(A.begin(), A.end(), S.begin(), B.begin(), pred, 0);
 *
 *  // B contains [0, 20, 0, 40]
 *  \endcode
 *
...
#include <hydra/detail/external/hydra_thrust/detail/replace.inl>
