...
#ifndef HYDRA_BOOST_MATH_PROMOTION_HPP
#define HYDRA_BOOST_MATH_PROMOTION_HPP
...
#if defined(HYDRA_BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
         //
...
#endif // HYDRA_BOOST_MATH_PROMOTION_HPP
