...
using pointer = hydra_thrust::pointer<
  ...
  hydra_thrust::tagged_reference<T, hydra_thrust::system::cpp::tag>
>;
 ...
 */
template <typename T>
using reference = hydra_thrust::reference<T, hydra_thrust::system::cpp::tag>;
 ...
 *  \brief \p hydra_thrust::cpp is a top-level alias for \p hydra_thrust::system::cpp. */
namespace cpp
{
using hydra_thrust::system::cpp::pointer;
using hydra_thrust::system::cpp::universal_pointer;
