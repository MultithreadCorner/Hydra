 ...
 *  \see std::malloc
 */
inline __hydra_host__ __hydra_device__ pointer<void> malloc(std::size_t n);
 ...
 */
template <typename T>
inline __hydra_host__ __hydra_device__ pointer<T> malloc(std::size_t n);
 ...
 *  \see std::free
 */
inline __hydra_host__ __hydra_device__ void free(pointer<void> ptr);
