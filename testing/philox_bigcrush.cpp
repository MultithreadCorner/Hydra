...
int main(int argv, char** argc)
{
   ...
   unif01_Gen* gen_a = unif01_CreateExternGenBits(const_cast<char*>("hydra::philox"), philox );

   if(battery==0) std::cout <<
		   "[Testing hydra::philox] : "
   ...
   freopen("hydra_philox_TestU01_log.txt", "w", stdout);
