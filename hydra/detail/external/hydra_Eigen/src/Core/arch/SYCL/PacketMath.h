...
#ifndef HYDRA_EIGEN_PACKET_MATH_SYCL_H
#define HYDRA_EIGEN_PACKET_MATH_SYCL_H
#include <type_traits>
...
#define SYCL_PLOADT_RO(address_space_target)                                 \
  ...
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type ploadt_ro(               \
...
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type
ploadt_ro(const hydra_Eigen::TensorSycl::internal::RangeAccess<
...
#define SYCL_PLOAD(address_space_target, Alignment, AlignedType)            \
  ...
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type pload##AlignedType(     \
      typename cl::sycl::multi_ptr<                                         \
          const typename unpacket_traits<packet_type>::type,                \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          from) {                                                           \
...
#define SYCL_PLOAD(Alignment, AlignedType)                              \
  template <typename packet_type>                                       \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type pload##AlignedType( \
      const hydra_Eigen::TensorSycl::internal::RangeAccess<                   \
...
#define SYCL_PLOADT(address_space_target)                                   \
  template <typename packet_type, int Alignment>                            \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type ploadt(                 \
      typename cl::sycl::multi_ptr<                                         \
          const typename unpacket_traits<packet_type>::type,                \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          from) {                                                           \
...
template <typename packet_type, int Alignment>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type
ploadt(const hydra_Eigen::TensorSycl::internal::RangeAccess<
       cl::sycl::access::mode::read_write,
...
#define SYCL_PLOAD_SPECIAL(packet_type, alignment_type)                    \
  template <>                                                              \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type pload##alignment_type( \
      const typename unpacket_traits<packet_type>::type* from) {           \
    typedef typename unpacket_traits<packet_type>::type scalar;            \
    auto res = packet_type(static_cast<scalar>(0));                        \
    res.template load<cl::sycl::access::address_space::private_space>(     \
...
#define SYCL_PSTORE(scalar, packet_type, address_space_target, alignment)   \
  template <>                                                               \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE void pstore##alignment(             \
      typename cl::sycl::multi_ptr<                                         \
          scalar,                                                           \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          to,                                                               \
...
#define SYCL_PSTORE_T(address_space_target)                                 \
  ...
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE void pstoret(                       \
      typename cl::sycl::multi_ptr<                                         \
          scalar,                                                           \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          to,                                                               \
...
#define SYCL_PSET1(packet_type)                                         \
  template <>                                                           \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type pset1<packet_type>( \
      const typename unpacket_traits<packet_type>::type& from) {        \
...
struct get_base_packet {
  ...
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE packet_type
...
struct get_base_packet<cl::sycl::cl_float4> {
  template <typename sycl_multi_pointer>
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_float4 get_ploaddup(
      sycl_multi_pointer from) {
    return cl::sycl::cl_float4(from[0], from[0], from[1], from[1]);
  }
  template <typename sycl_multi_pointer>
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_float4 get_pgather(
  ...
  template <typename sycl_multi_pointer>
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE void set_pscatter(
  ...
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_float4 set_plset(
      const float& a) {
...
struct get_base_packet<cl::sycl::cl_double2> {
  template <typename sycl_multi_pointer>
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_double2
  ...
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_double2 get_pgather(
  ...
  static HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE cl::sycl::cl_double2 set_plset(
      const double& a) {
...
#define SYCL_PLOAD_DUP(address_space_target)                                \
  template <typename packet_type>                                           \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE packet_type ploaddup(               \
      typename cl::sycl::multi_ptr<                                         \
          const typename unpacket_traits<packet_type>::type,                \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          from) {                                                           \
...
#define SYCL_PLOAD_DUP_SPECILIZE(packet_type)                              \
  template <>                                                              \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE packet_type ploaddup<packet_type>( \
      const typename unpacket_traits<packet_type>::type* from) {           \
    return get_base_packet<packet_type>::get_ploaddup(from);               \
  }
...
#define SYCL_PLSET(packet_type)                                         \
  template <>                                                           \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type plset<packet_type>( \
...
#define SYCL_PGATHER(address_space_target)                                  \
  ...
  HYDRA_EIGEN_DEVICE_FUNC inline packet_type pgather(                             \
      typename cl::sycl::multi_ptr<                                         \
          const typename unpacket_traits<packet_type>::type,                \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          from,                                                             \
...
#define SYCL_PGATHER_SPECILIZE(scalar, packet_type)                            \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE packet_type                            \
...
#define SYCL_PSCATTER(address_space_target)                                 \
  template <typename Scalar, typename packet_type>                          \
  HYDRA_EIGEN_DEVICE_FUNC inline void pscatter(                                   \
      typename cl::sycl::multi_ptr<                                         \
          typename unpacket_traits<packet_type>::type,                      \
          cl::sycl::access::address_space::address_space_target>::pointer_t \
          to,                                                               \
...
#define SYCL_PSCATTER_SPECILIZE(scalar, packet_type)                        \
  template <>                                                               \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE void pscatter<scalar, packet_type>( \
...
#define SYCL_PMAD(packet_type)                                            \
  template <>                                                             \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE packet_type pmadd(                \
...
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE float pfirst<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4& a) {
  return a.x();
}
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE double pfirst<cl::sycl::cl_double2>(
    const cl::sycl::cl_double2& a) {
  return a.x();
}

template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE float predux<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4& a) {
  return a.x() + a.y() + a.z() + a.w();
}

template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE double predux<cl::sycl::cl_double2>(
    const cl::sycl::cl_double2& a) {
  return a.x() + a.y();
}

template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE float predux_max<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4& a) {
  return cl::sycl::fmax(cl::sycl::fmax(a.x(), a.y()),
                        cl::sycl::fmax(a.z(), a.w()));
}
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE double predux_max<cl::sycl::cl_double2>(
    const cl::sycl::cl_double2& a) {
  return cl::sycl::fmax(a.x(), a.y());
}

template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE float predux_min<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4& a) {
  return cl::sycl::fmin(cl::sycl::fmin(a.x(), a.y()),
                        cl::sycl::fmin(a.z(), a.w()));
}
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE double predux_min<cl::sycl::cl_double2>(
    const cl::sycl::cl_double2& a) {
  return cl::sycl::fmin(a.x(), a.y());
}

template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE float predux_mul<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4& a) {
  return a.x() * a.y() * a.z() * a.w();
}
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE double predux_mul<cl::sycl::cl_double2>(
    const cl::sycl::cl_double2& a) {
  return a.x() * a.y();
}
...
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE Packet sycl_pcmp_le(const Packet &a,
                                                          const Packet &b) {
  return ((a <= b)
...
template <typename Packet>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE Packet sycl_pcmp_lt(const Packet &a,
                                                          const Packet &b) {
  return ((a < b)
              .template convert<typename unpacket_traits<Packet>::type,
                                cl::sycl::rounding_mode::automatic>());
...
template <typename Packet>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE Packet sycl_pcmp_eq(const Packet &a,
                                                          const Packet &b) {
  return ((a == b)
              .template convert<typename unpacket_traits<Packet>::type,
                                cl::sycl::rounding_mode::automatic>());
...
#define SYCL_PCMP(OP, TYPE)                                                    \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE TYPE pcmp_##OP<TYPE>(const TYPE &a,    \
                                                             const TYPE &b) {  \
...
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE typename convert_to_integer<
...
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE packetOut
...
#define SYCL_PAND(TYPE)                                                        \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE TYPE pand<TYPE>(const TYPE &a,         \
                                                        const TYPE &b) {       \
...
#define SYCL_POR(TYPE)                                                         \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE TYPE por<TYPE>(const TYPE &a,          \
                                                       const TYPE &b) {        \
    return convert_vector<TYPE>(vector_as_int(a) | vector_as_int(b));          \
  }
...
#define SYCL_PXOR(TYPE)                                                        \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE TYPE pxor<TYPE>(const TYPE &a,         \
                                                        const TYPE &b) {       \
    return convert_vector<TYPE>(vector_as_int(a) ^ vector_as_int(b));          \
  }
...
#define SYCL_PANDNOT(TYPE)                                                     \
  template <>                                                                  \
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_STRONG_INLINE TYPE pandnot<TYPE>(const TYPE &a,      \
                                                           const TYPE &b) {    \
    return convert_vector<TYPE>(vector_as_int(a) & (~vector_as_int(b)));       \
  }
...
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE void ptranspose(
...
template <>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE cl::sycl::cl_float4 pblend(
...
template <typename scalar, typename packet_type, int Alignment>
HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_ALWAYS_INLINE void pstoret(
    hydra_Eigen::TensorSycl::internal::RangeAccess<
        cl::sycl::access::mode::read_write,
        typename unpacket_traits<packet_type>::type>
        to,
    const packet_type& from) {
...
#endif  // HYDRA_EIGEN_PACKET_MATH_SYCL_H
