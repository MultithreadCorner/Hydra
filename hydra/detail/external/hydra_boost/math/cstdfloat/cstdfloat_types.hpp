...
// Implement the types for floating-point typedefs having specified widths.
  ...
  namespace boost
  {
      ...
      static_assert(std::numeric_limits<boost::float16_t>::is_iec559    == true, "boost::float16_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float16_t>::radix        ==    2, "boost::float16_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float16_t>::digits       ==   11, "boost::float16_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float16_t>::max_exponent ==   16, "boost::float16_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      static_assert(std::numeric_limits<boost::float32_t>::is_iec559    == true, "boost::float32_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float32_t>::radix        ==    2, "boost::float32_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float32_t>::digits       ==   24, "boost::float32_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float32_t>::max_exponent ==  128, "boost::float32_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
...
#define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 64
      ...
      static_assert(std::numeric_limits<boost::float64_t>::is_iec559    == true, "boost::float64_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float64_t>::radix        ==    2, "boost::float64_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float64_t>::digits       ==   53, "boost::float64_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float64_t>::max_exponent == 1024, "boost::float64_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      static_assert(std::numeric_limits<boost::float80_t>::is_iec559    ==  true, "boost::float80_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float80_t>::radix        ==     2, "boost::float80_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float80_t>::digits       ==    64, "boost::float80_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float80_t>::max_exponent == 16384, "boost::float80_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      #else
      static_assert(std::numeric_limits<boost::float128_t>::is_iec559    ==  true, "boost::float128_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float128_t>::radix        ==     2, "boost::float128_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float128_t>::digits       ==   113, "boost::float128_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<boost::float128_t>::max_exponent == 16384, "boost::float128_t has been detected in <hydra/detail/external/hydra_boost/cstdfloat>, but verification with std::numeric_limits fails");
      #endif
