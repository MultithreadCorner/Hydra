                                ...
                                UnaryFunction f)
{
  ...
  HYDRA_EXTERNAL_NS::thrust::detail::wrapped_function<UnaryFunction,void> wrapped_f(f);
...
// XXX implement the body of this function in another file to eliminate this ugliness
  ...
  typedef typename HYDRA_EXTERNAL_NS::thrust::iterator_difference<RandomAccessIterator>::type DifferenceType;
...
template<typename DerivedPolicy,
  ...
  RandomAccessIterator for_each(execution_policy<DerivedPolicy> &s,
                                ...
                                UnaryFunction f)
{
  return omp::detail::for_each_n(s, first, HYDRA_EXTERNAL_NS::thrust::distance(first,last), f);
} // end for_each()
