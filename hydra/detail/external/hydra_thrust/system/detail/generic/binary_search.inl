                         ...
                         BinarySearchFunction func)
{
  ...
  { // copy value to device
    typedef typename hydra_thrust::iterator_system<const T*>::type value_in_system_t;
    value_in_system_t value_in_system;
    using hydra_thrust::system::detail::generic::select_system;
    hydra_thrust::copy_n(select_system(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(value_in_system)),
  ...
  { // copy result to host and return
    typedef typename hydra_thrust::iterator_system<OutputType*>::type result_out_system_t;
    result_out_system_t result_out_system;
    using hydra_thrust::system::detail::generic::select_system;
    hydra_thrust::copy_n(select_system(hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(exec)),
                                 hydra_thrust::detail::derived_cast(hydra_thrust::detail::strip_const(result_out_system))),
