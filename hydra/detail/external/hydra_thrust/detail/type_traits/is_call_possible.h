  ...
  private:                                                                                                                                \
    ...
    {                                                                                                                                     \
      ...
      no member_function_name(...) const;                                                                                                 \
                                                                                                                                          ...
                                                                                                                                          \
    typedef typename hydra_thrust::detail::is_call_possible_detail::clone_constness<T, derived>::type derived_type;                             \
                                                                                                                                          \
    ...
    {                                                                                                                                     \
      ...
      static no deduce(...);                                                                                                              \
      static no deduce(no);                                                                                                               \
      static no deduce(hydra_thrust::detail::is_call_possible_detail::void_exp_result<T>);                                                      \
    };                                                                                                                                    \
                                                                                                                                          \
    template<typename U>                                                                                                                  \
      ...
      static const bool value =                                                                                                           \
        sizeof(                                                                                                                           \
                return_value_check<T, Result>::deduce(                                                                                    \
                  (test_me.member_function_name(arg), hydra_thrust::detail::is_call_possible_detail::void_exp_result<T>())                      \
                )                                                                                                                         \
              ) == sizeof(yes);                                                                                                           \
    };                                                                                                                                    \
                                                                                                                                          \
    ...
    {                                                                                                                                     \
      ...
      static const bool value =                                                                                                           \
        sizeof(                                                                                                                           \
                return_value_check<T, Result>::deduce(                                                                                    \
                  (test_me.member_function_name(arg1,arg2), hydra_thrust::detail::is_call_possible_detail::void_exp_result<T>())                \
                )                                                                                                                         \
              ) == sizeof(yes);                                                                                                           \
    };                                                                                                                                    \
                                                                                                                                          \
    ...
    {                                                                                                                                     \
      ...
      static const bool value =                                                                                                           \
        sizeof(                                                                                                                           \
                return_value_check<T, Result>::deduce(                                                                                    \
                  (test_me.member_function_name(arg1,arg2,arg3), hydra_thrust::detail::is_call_possible_detail::void_exp_result<T>())           \
                )                                                                                                                         \
              ) == sizeof(yes);                                                                                                           \
    };                                                                                                                                    \
                                                                                                                                          \
    ...
    {                                                                                                                                     \
      ...
      static const bool value =                                                                                                           \
        sizeof(                                                                                                                           \
                return_value_check<T, Result>::deduce(                                                                                    \
                  (test_me.member_function_name(arg1,arg2,arg3,arg4), hydra_thrust::detail::is_call_possible_detail::void_exp_result<T>())      \
                )                                                                                                                         \
              ) == sizeof(yes);                                                                                                           \
    };                                                                                                                                    \
                                                                                                                                          \
