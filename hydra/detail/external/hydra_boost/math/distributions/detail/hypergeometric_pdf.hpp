...
T hypergeometric_pdf_lanczos_imp(T /*dummy*/, std::uint64_t x, std::uint64_t r, std::uint64_t n, std::uint64_t N, const hydra_boost::math::lanczos::undefined_lanczos&, const Policy& pol)
{
   HYDRA_BOOST_MATH_STD_USING
   return exp(
