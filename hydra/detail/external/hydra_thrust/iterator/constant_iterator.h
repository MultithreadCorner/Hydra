...
/*! \file hydra_thrust/iterator/constant_iterator.h
 ...
 *
 *  hydra_thrust::constant_iterator<int> iter(10);
 *
 *  *iter;    // returns 10
 *  iter[0];  // returns 10
 *  iter[1];  // returns 10
 ...
 *  \p hydra_thrust::transform function to increment all elements of a sequence by the
 ...
 *  int main()
 *  {
 *    hydra_thrust::device_vector<int> data(4);
 *    data[0] = 3;
 *    data[1] = 7;
 *    data[2] = 2;
 *    data[3] = 5;
 ...
 *    hydra_thrust::transform(data.begin(), data.end(),
 *                      hydra_thrust::make_constant_iterator(10),
 *                      data.begin(),
 *                      hydra_thrust::plus<int>());
 *    
