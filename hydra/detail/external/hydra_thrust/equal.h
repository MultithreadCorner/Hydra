 ...
 *  two ranges for equality using the \p hydra_thrust::host execution policy:
 *
 *  \code
 ...
 *  ...
 *  bool result = hydra_thrust::equal(hydra_thrust::host, A1, A1 + 7, A2);
 *
 *  // result == false
 *  \endcode
 *
...
__host__ __device__
bool equal(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2);
 ...
 *  int A2[7] = {3, 1, 4, 2, 8, 5, 7};
 *  ...
 *  bool result = hydra_thrust::equal(A1, A1 + 7, A2);
 *
 *  // result == false
 *  \endcode
 *
 ...
 *  elements in two ranges modulo 2 using the \p hydra_thrust::host execution policy.
 *
 *  \code
 *  #include <hydra/detail/external/hydra_thrust/equal.h>
 *  #include <hydra/detail/external/hydra_thrust/execution_policy.h>
 ...
 *
 *  bool result = hydra_thrust::equal(x, x + 6, y, compare_modulo_two());
 *
 *  // result is false
 *  \endcode
 *
...
__host__ __device__
bool equal(const hydra_thrust::detail::execution_policy_base<DerivedPolicy> &exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, BinaryPredicate binary_pred);
 ...
 *  int y[6] = {1, 3, 5, 7, 9, 11};
 *
 *  bool result = hydra_thrust::equal(x, x + 5, y, compare_modulo_two());
 *
 *  // result is true
 *  \endcode
 *
...
#include <hydra/detail/external/hydra_thrust/detail/equal.inl>
