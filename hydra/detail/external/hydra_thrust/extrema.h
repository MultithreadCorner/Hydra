 ...
 *  key_value b = { 7, 1);
 *
 *  key_value smaller = hydra_thrust::min(a, b, compare_key_value());
 *
 *  // smaller is {7, 1}
 *  \endcode
 *
 ...
 *  int b = 7;
 *
 *  int smaller = hydra_thrust::min(a, b);
 *
 *  // smaller is 7
 *  \endcode
 *
 ...
 *  key_value b = { 7, 1);
 *
 *  key_value larger = hydra_thrust::max(a, b, compare_key_value());
 *
 *  // larger is {13, 0}
 *  \endcode
 *
 ...
 *  int b = 7;
 *
 *  int larger = hydra_thrust::min(a, b);
 *
 *  // larger is 13
 *  \endcode
 *
 ...
 *  int *result = hydra_thrust::min_element(hydra_thrust::host, data, data + 6);
 *
 *  // result is data + 1
 *  // *result is 0
 *  \endcode
 ...
 *  ...
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *  int *result = hydra_thrust::min_element(data, data + 6);
 *
 *  // result is data + 1
 *  // *result is 0
 *  \endcode
 ...
 *
 *  key_value *smallest = hydra_thrust::min_element(hydra_thrust::host, data, data + 4, compare_key_value());
 *
 *  // smallest == data + 1
 *  // *smallest == {0,7}
 *  \endcode
 ...
 *  key_value data[4] = { {4,5}, {0,7}, {2,3}, {6,1} };
 *
 *  key_value *smallest = hydra_thrust::min_element(data, data + 4, compare_key_value());
 *
 *  // smallest == data + 1
 *  // *smallest == {0,7}
 *  \endcode
 ...
 *  ...
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *  int *result = hydra_thrust::max_element(hydra_thrust::host, data, data + 6);
 *
 *  // *result == 3
 *  \endcode
 *
 ...
 *  ...
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *  int *result = hydra_thrust::max_element(data, data + 6);
 *
 *  // *result == 3
 *  \endcode
 *
 ...
 *  key_value data[4] = { {4,5}, {0,7}, {2,3}, {6,1} };
 *
 *  key_value *largest = hydra_thrust::max_element(hydra_thrust::host, data, data + 4, compare_key_value());
 *
 *  // largest == data + 3
 *  // *largest == {6,1}
 *  \endcode
 ...
 *  key_value data[4] = { {4,5}, {0,7}, {2,3}, {6,1} };
 *
 *  key_value *largest = hydra_thrust::max_element(data, data + 4, compare_key_value());
 *
 *  // largest == data + 3
 *  // *largest == {6,1}
 *  \endcode
 ...
 *  ...
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *  hydra_thrust::pair<int *, int *> result = hydra_thrust::minmax_element(hydra_thrust::host, data, data + 6);
 *
 ...
 *  ...
 *  int data[6] = {1, 0, 2, 2, 1, 3};
 *  hydra_thrust::pair<int *, int *> result = hydra_thrust::minmax_element(data, data + 6);
 *
 *  // result.first is data + 1
 *  // result.second is data + 5
 *  // *result.first is 0
 ...
 */
template <typename ForwardIterator>
hydra_thrust::pair<ForwardIterator,ForwardIterator> minmax_element(ForwardIterator first, 
 ...
 *  key_value data[4] = { {4,5}, {0,7}, {2,3}, {6,1} };
 *
 *  hydra_thrust::pair<key_value*,key_value*> extrema = hydra_thrust::minmax_element(hydra_thrust::host, data, data + 4, compare_key_value());
 *
 ...
 *  key_value data[4] = { {4,5}, {0,7}, {2,3}, {6,1} };
 *
 *  hydra_thrust::pair<key_value*,key_value*> extrema = hydra_thrust::minmax_element(data, data + 4, compare_key_value());
 *
 *  // extrema.first   == data + 1
 *  // *extrema.first  == {0,7}
 *  // extrema.second  == data + 3
