...
#define CUB_NS_PREFIX namespace hydra { namespace detail { namespace external {  namespace thrust { namespace system { namespace cuda { namespace detail {
...
#include <hydra/detail/external/thrust/system/cuda/detail/cub/util_namespace.cuh>
#include <hydra/detail/external/thrust/system/cuda/detail/cub/cub.cuh>
