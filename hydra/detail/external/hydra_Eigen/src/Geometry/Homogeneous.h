  ...
  : public MatrixBase<Homogeneous<MatrixType,_Direction> >, internal::no_assignment_operator
{
  public:
    ...
    inline Index rows() const HYDRA_EIGEN_NOEXCEPT { return m_matrix.rows() + (int(Direction)==Vertical   ? 1 : 0); }
    HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_CONSTEXPR
    inline Index cols() const HYDRA_EIGEN_NOEXCEPT { return m_matrix.cols() + (int(Direction)==Horizontal ? 1 : 0); }
  ...
  : public ReturnByValue<homogeneous_left_product_impl<Homogeneous<MatrixType,Vertical>,Lhs> >
{
  ...
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_CONSTEXPR
  inline Index rows() const HYDRA_EIGEN_NOEXCEPT { return m_lhs.rows(); }
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_CONSTEXPR
  inline Index cols() const HYDRA_EIGEN_NOEXCEPT { return m_rhs.cols(); }
  ...
  : public ReturnByValue<homogeneous_right_product_impl<Homogeneous<MatrixType,Horizontal>,Rhs> >
{
  ...
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_CONSTEXPR inline Index rows() const HYDRA_EIGEN_NOEXCEPT { return m_lhs.rows(); }
  HYDRA_EIGEN_DEVICE_FUNC HYDRA_EIGEN_CONSTEXPR inline Index cols() const HYDRA_EIGEN_NOEXCEPT { return m_rhs.cols(); }
