 ...
 *
 *  \code
 *  struct sine : public hydra_thrust::unary_function<float,float>
 *  {
 *    __host__ __device__
 ...
 *
 *  \code
 *  struct exponentiate : public hydra_thrust::binary_function<float,float,float>
 *  {
 *    __host__ __device__
 ...
 *  ...
 *  const int N = 1000;
 *  hydra_thrust::device_vector<float> V1(N);
 *  hydra_thrust::device_vector<float> V2(N);
 *  hydra_thrust::device_vector<float> V3(N);
 *
 *  hydra_thrust::sequence(V1.begin(), V1.end(), 1);
 *  hydra_thrust::fill(V2.begin(), V2.end(), 75);
 *
 *  hydra_thrust::transform(V1.begin(), V1.end(), V2.begin(), V3.begin(),
 *                    hydra_thrust::plus<float>());
 ...
 *  hydra_thrust::sequence(V1.begin(), V1.end(), 1);
 *
 *  hydra_thrust::transform(V1.begin(), V1.end(), V2.begin(),
 *                    hydra_thrust::negate<float>());
 ...
 *  #include <hydra/detail/external/hydra_thrust/functional.h>
 *  ...
 *  hydra_thrust::device_vector<bool> V;
 *  ...
 *  hydra_thrust::transform(V.begin(), V.end(), V.begin(), hydra_thrust::logical_not<bool>());
 ...
 *  ...
 *  const int N = 1000;
 *  hydra_thrust::device_vector<int> V1(N);
 *  hydra_thrust::device_vector<int> V2(N);
 *  hydra_thrust::device_vector<int> V3(N);
 *
 *  hydra_thrust::sequence(V1.begin(), V1.end(), 1);
 *  hydra_thrust::fill(V2.begin(), V2.end(), 13);
 *
 *  hydra_thrust::transform(V1.begin(), V1.end(), V2.begin(), V3.begin(),
 *                    hydra_thrust::bit_and<int>());
 ...
 *  int x =  137;
 *  int y = -137;
 *  hydra_thrust::project1st<int> pj1;
 *  assert(x == pj1(x,y));
 *  \endcode
 *
 *  \see identity
 ...
 *  int x =  137;
 *  int y = -137;
 *  hydra_thrust::project2nd<int> pj2;
 *  assert(y == pj2(x,y));
 *  \endcode
 *
 *  \see identity
...
/*! \namespace hydra_thrust::placeholders
 *  \brief Facilities for constructing simple functions inline.
 *
 *  Objects in the \p hydra_thrust::placeholders namespace may be used to create simple arithmetic functions inline
 ...
 *
 *  The following code snippet demonstrates how to use the placeholders \p _1 and \p _2 with \p hydra_thrust::transform
 ...
 *  int main()
 *  {
 *    hydra_thrust::device_vector<float> x(4), y(4);
 *    x[0] = 1;
 *    x[1] = 2;
 *    x[2] = 3;
 *    x[3] = 4;
 ...
 *
 *    hydra_thrust::transform(x.begin(), x.end(), y.begin(), y.begin(),
 *      a * _1 + _2
 *    );
 *
 *    // y is now {3, 5, 7, 9}
