  ...
  : public PlainObjectBase<Array<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols> >
{
  ...
  public:
    ...
    HYDRA_EIGEN_DEVICE_FUNC inline Index innerStride() const { return 1; }
    HYDRA_EIGEN_DEVICE_FUNC inline Index outerStride() const { return this->innerSize(); }
...
#undef HYDRA_EIGEN_MAKE_ARRAY_TYPEDEFS_LARGE

#define HYDRA_EIGEN_USING_ARRAY_TYPEDEFS_FOR_TYPE_AND_SIZE(TypeSuffix, SizeSuffix) \
using HYDRA_EXTERNAL_NS::Eigen::Matrix##SizeSuffix##TypeSuffix; \
using HYDRA_EXTERNAL_NS::Eigen::Vector##SizeSuffix##TypeSuffix; \
using HYDRA_EXTERNAL_NS::Eigen::RowVector##SizeSuffix##TypeSuffix;
