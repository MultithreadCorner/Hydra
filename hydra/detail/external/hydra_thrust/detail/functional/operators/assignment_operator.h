...
struct assign
{
  ...
  noexcept(noexcept(HYDRA_THRUST_FWD(t1) = HYDRA_THRUST_FWD(t2)))
  HYDRA_THRUST_TRAILING_RETURN(decltype(HYDRA_THRUST_FWD(t1) = HYDRA_THRUST_FWD(t2)))
  {
    return HYDRA_THRUST_FWD(t1) = HYDRA_THRUST_FWD(t2);
  }
};
